...
func (q countryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Country, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "liteboil: failed to execute a one query for country")
	}
...
func (q countryQuery) All(ctx context.Context, exec boil.ContextExecutor) (CountrySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "liteboil: failed to assign all query results to Country slice")
	}
...
func (q countryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to count country rows")
	}
...
func (q countryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "liteboil: failed to check if country exists")
	}
...
func FindCountry(ctx context.Context, exec boil.ContextExecutor, code string, selectCols ...string) (*Country, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "liteboil: unable to select from country")
	}
...
func (o *Country) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("liteboil: no country provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "liteboil: unable to insert into country")
	}
...
func (o *Country) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("liteboil: unable to update country, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to update country row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to get rows affected by update for country")
	}
...
func (q countryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to update all for country")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to retrieve rows affected for country")
	}
...
func (o CountrySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to update all in country slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to retrieve rows affected all in update all country")
	}
	return rowsAff, nil
}
...
func (o *Country) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("liteboil: no country provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("liteboil: unable to upsert country, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "liteboil: unable to upsert country")
	}
...
func (o *Country) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("liteboil: no Country provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to delete from country")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to get rows affected by delete for country")
	}
...
func (q countryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("liteboil: no countryQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to delete all from country")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to get rows affected by deleteall for country")
	}
...
func (o CountrySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to delete all from country slice")
	}
...
func (o *Country) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("liteboil: no Country provided for reload")
	}
...
func (o *CountrySlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("liteboil: empty CountrySlice provided for reload all")
	}
...
func (o *CountrySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "liteboil: unable to reload all in CountrySlice")
	}
...
func CountryExists(ctx context.Context, exec boil.ContextExecutor, code string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "liteboil: unable to check if country exists")
	}
