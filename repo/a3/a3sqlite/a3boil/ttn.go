...
var TTNWhere = struct {
	...
	DocShippingDate:      whereHelpernull_String{field: "\"ttn\".\"doc_shipping_date\""},
	DocBase:              whereHelpernull_String{field: "\"ttn\".\"doc_base\""},
	DocComment:           whereHelpernull_String{field: "\"ttn\".\"doc_comment\""},
	ShipperType:          whereHelpernull_String{field: "\"ttn\".\"shipper_type\""},
	ShipperClientRegID:   whereHelpernull_String{field: "\"ttn\".\"shipper_client_reg_id\""},
	ShipperInn:           whereHelpernull_String{field: "\"ttn\".\"shipper_inn\""},
	ShipperKPP:           whereHelpernull_String{field: "\"ttn\".\"shipper_kpp\""},
	ShipperFullName:      whereHelpernull_String{field: "\"ttn\".\"shipper_full_name\""},
	ShipperShortName:     whereHelpernull_String{field: "\"ttn\".\"shipper_short_name\""},
	ShipperCountryCode:   whereHelpernull_String{field: "\"ttn\".\"shipper_country_code\""},
	ShipperRegionCode:    whereHelpernull_String{field: "\"ttn\".\"shipper_region_code\""},
	ShipperDescription:   whereHelpernull_String{field: "\"ttn\".\"shipper_description\""},
	ConsigneeType:        whereHelpernull_String{field: "\"ttn\".\"consignee_type\""},
	ConsigneeClientRegID: whereHelpernull_String{field: "\"ttn\".\"consignee_client_reg_id\""},
	ConsigneeInn:         whereHelpernull_String{field: "\"ttn\".\"consignee_inn\""},
	ConsigneeKPP:         whereHelpernull_String{field: "\"ttn\".\"consignee_kpp\""},
	ConsigneeFullName:    whereHelpernull_String{field: "\"ttn\".\"consignee_full_name\""},
	ConsigneeShortName:   whereHelpernull_String{field: "\"ttn\".\"consignee_short_name\""},
	ConsigneeCountryCode: whereHelpernull_String{field: "\"ttn\".\"consignee_country_code\""},
	ConsigneeRegionCode:  whereHelpernull_String{field: "\"ttn\".\"consignee_region_code\""},
	ConsigneeDescription: whereHelpernull_String{field: "\"ttn\".\"consignee_description\""},
	TranType:             whereHelpernull_String{field: "\"ttn\".\"tran_type\""},
	TransportCompany:     whereHelpernull_String{field: "\"ttn\".\"transport_company\""},
	TransportCustomer:    whereHelpernull_String{field: "\"ttn\".\"transport_customer\""},
	TransportOwnership:   whereHelpernull_String{field: "\"ttn\".\"transport_ownership\""},
	TransportType:        whereHelpernull_String{field: "\"ttn\".\"transport_type\""},
	TransportDriver:      whereHelpernull_String{field: "\"ttn\".\"transport_driver\""},
	TransportTrailer:     whereHelpernull_String{field: "\"ttn\".\"transport_trailer\""},
	TransportRegNumber:   whereHelpernull_String{field: "\"ttn\".\"transport_reg_number\""},
	TransportForwarder:   whereHelpernull_String{field: "\"ttn\".\"transport_forwarder\""},
	TransportLoadPoint:   whereHelpernull_String{field: "\"ttn\".\"transport_load_point\""},
	TransportUnloadPoint: whereHelpernull_String{field: "\"ttn\".\"transport_unload_point\""},
	TransportRedirect:    whereHelpernull_String{field: "\"ttn\".\"transport_redirect\""},
	Version:              whereHelpernull_String{field: "\"ttn\".\"version\""},
	State:                whereHelpernull_String{field: "\"ttn\".\"state\""},
	Status:               whereHelpernull_String{field: "\"ttn\".\"status\""},
	ReplyID:              whereHelpernull_String{field: "\"ttn\".\"reply_id\""},
	Archive:              whereHelpernull_Int64{field: "\"ttn\".\"archive\""},
	XML:                  whereHelpernull_String{field: "\"ttn\".\"xml\""},
}
...
func TTNS(mods ...qm.QueryMod) ttnQuery {
	mods = append(mods, qm.From("\"ttn\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ttn\".*"})
	}
...
func FindTTNG(ctx context.Context, iD int64, selectCols ...string) (*TTN, error) {
	return FindTTN(ctx, boil.GetContextDB(), iD, selectCols...)
}

// FindTTN retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindTTN(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*TTN, error) {
	ttnObj := &TTN{}
	...
	query := fmt.Sprintf(
		"select %s from \"ttn\" where \"id\"=?", sel,
	)
...
func (o *TTN) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ttn\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ttn\" %sDEFAULT VALUES%s"
		}
...
func (o *TTN) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ttn\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, ttnPrimaryKeyColumns),
		)
...
func (o TTNSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ttn\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnPrimaryKeyColumns, len(o)))
...
func (o *TTN) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TTN) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(ttnPrimaryKeyColumns))
			copy(conflict, ttnPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"ttn\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(ttnType, ttnMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func TTNExistsG(ctx context.Context, iD int64) (bool, error) {
	return TTNExists(ctx, boil.GetContextDB(), iD)
}

// TTNExists checks if the TTN row exists.
func TTNExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ttn\" where \"id\"=? limit 1)"
