...
var TTNForm2Where = struct {
	...
	ID:                   whereHelperint64{field: "\"ttn_form2\".\"id\""},
	IDTTN:                whereHelpernull_Int64{field: "\"ttn_form2\".\"id_ttn\""},
	DocIddomain:          whereHelpernull_String{field: "\"ttn_form2\".\"doc_iddomain\""},
	DocRegID:             whereHelpernull_String{field: "\"ttn_form2\".\"doc_reg_id\""},
	DocFixNumber:         whereHelpernull_String{field: "\"ttn_form2\".\"doc_fix_number\""},
	DocFixDate:           whereHelpernull_String{field: "\"ttn_form2\".\"doc_fix_date\""},
	DocNumber:            whereHelpernull_String{field: "\"ttn_form2\".\"doc_number\""},
	DocDate:              whereHelpernull_String{field: "\"ttn_form2\".\"doc_date\""},
	ShipperType:          whereHelpernull_String{field: "\"ttn_form2\".\"shipper_type\""},
	ShipperClientRegID:   whereHelpernull_String{field: "\"ttn_form2\".\"shipper_client_reg_id\""},
	ShipperInn:           whereHelpernull_String{field: "\"ttn_form2\".\"shipper_inn\""},
	ShipperKPP:           whereHelpernull_String{field: "\"ttn_form2\".\"shipper_kpp\""},
	ShipperFullName:      whereHelpernull_String{field: "\"ttn_form2\".\"shipper_full_name\""},
	ShipperShortName:     whereHelpernull_String{field: "\"ttn_form2\".\"shipper_short_name\""},
	ShipperCountryCode:   whereHelpernull_String{field: "\"ttn_form2\".\"shipper_country_code\""},
	ShipperRegionCode:    whereHelpernull_String{field: "\"ttn_form2\".\"shipper_region_code\""},
	ShipperDescription:   whereHelpernull_String{field: "\"ttn_form2\".\"shipper_description\""},
	ConsigneeType:        whereHelpernull_String{field: "\"ttn_form2\".\"consignee_type\""},
	ConsigneeClientRegID: whereHelpernull_String{field: "\"ttn_form2\".\"consignee_client_reg_id\""},
	ConsigneeInn:         whereHelpernull_String{field: "\"ttn_form2\".\"consignee_inn\""},
	ConsigneeKPP:         whereHelpernull_String{field: "\"ttn_form2\".\"consignee_kpp\""},
	ConsigneeFullName:    whereHelpernull_String{field: "\"ttn_form2\".\"consignee_full_name\""},
	ConsigneeShortName:   whereHelpernull_String{field: "\"ttn_form2\".\"consignee_short_name\""},
	ConsigneeCountryCode: whereHelpernull_String{field: "\"ttn_form2\".\"consignee_country_code\""},
	ConsigneeRegionCode:  whereHelpernull_String{field: "\"ttn_form2\".\"consignee_region_code\""},
	ConsigneeDescription: whereHelpernull_String{field: "\"ttn_form2\".\"consignee_description\""},
	XML:                  whereHelpernull_String{field: "\"ttn_form2\".\"xml\""},
}
...
var (
	...
	ttnForm2ColumnsWithoutDefault = []string{}
	ttnForm2ColumnsWithDefault    = []string{"id", "id_ttn", "doc_iddomain", "doc_reg_id", "doc_fix_number", "doc_fix_date", "doc_number", "doc_date", "shipper_type", "shipper_client_reg_id", "shipper_inn", "shipper_kpp", "shipper_full_name", "shipper_short_name", "shipper_country_code", "shipper_region_code", "shipper_description", "consignee_type", "consignee_client_reg_id", "consignee_inn", "consignee_kpp", "consignee_full_name", "consignee_short_name", "consignee_country_code", "consignee_region_code", "consignee_description", "xml"}
...
func TTNForm2s(mods ...qm.QueryMod) ttnForm2Query {
	mods = append(mods, qm.From("\"ttn_form2\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ttn_form2\".*"})
	}
...
func FindTTNForm2G(ctx context.Context, iD int64, selectCols ...string) (*TTNForm2, error) {
...
func FindTTNForm2(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*TTNForm2, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"ttn_form2\" where \"id\"=?", sel,
	)
...
func (o *TTNForm2) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ttn_form2\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ttn_form2\" %sDEFAULT VALUES%s"
		}
...
func (o *TTNForm2) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ttn_form2\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, ttnForm2PrimaryKeyColumns),
		)
...
func (o TTNForm2Slice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ttn_form2\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnForm2PrimaryKeyColumns, len(o)))
...
func (o *TTNForm2) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TTNForm2) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(ttnForm2PrimaryKeyColumns))
			copy(conflict, ttnForm2PrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"ttn_form2\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(ttnForm2Type, ttnForm2Mapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *TTNForm2) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_form2\" WHERE \"id\"=?"
...
func (o *TTNForm2Slice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"ttn_form2\".* FROM \"ttn_form2\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnForm2PrimaryKeyColumns, len(*o))
...
func TTNForm2ExistsG(ctx context.Context, iD int64) (bool, error) {
	return TTNForm2Exists(ctx, boil.GetContextDB(), iD)
}

// TTNForm2Exists checks if the TTNForm2 row exists.
func TTNForm2Exists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ttn_form2\" where \"id\"=? limit 1)"
