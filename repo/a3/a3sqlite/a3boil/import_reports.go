...
var ImportReportWhere = struct {
	...
	DocIddomain:         whereHelpernull_String{field: "\"import_reports\".\"doc_iddomain\""},
...
var (
	...
	importReportColumnsWithDefault    = []string{"id", "create_date", "doc_iddomain", "doc_number", "doc_date", "doc_imported_date", "contract_number", "contract_date", "gtd_number", "gtd_date", "doc_comment", "importer_type", "importer_client_reg_id", "importer_inn", "importer_kpp", "importer_full_name", "importer_short_name", "importer_country_code", "importer_region_code", "importer_description", "supplier_type", "supplier_client_reg_id", "supplier_inn", "supplier_kpp", "supplier_full_name", "supplier_short_name", "supplier_country_code", "supplier_region_code", "supplier_description", "version", "state", "status", "reply_id", "archive", "xml"}
