...
var TTNProductWhere = struct {
	...
	ID:                   whereHelperint64{field: "\"ttn_products\".\"id\""},
	IDTTN:                whereHelpernull_Int64{field: "\"ttn_products\".\"id_ttn\""},
	ProductFullName:      whereHelpernull_String{field: "\"ttn_products\".\"product_full_name\""},
	ProductCapacity:      whereHelpernull_String{field: "\"ttn_products\".\"product_capacity\""},
	ProductAlcVolume:     whereHelpernull_String{field: "\"ttn_products\".\"product_alc_volume\""},
	ProductAlcCode:       whereHelpernull_String{field: "\"ttn_products\".\"product_alc_code\""},
	ProductCode:          whereHelpernull_String{field: "\"ttn_products\".\"product_code\""},
	ProductUnitType:      whereHelpernull_String{field: "\"ttn_products\".\"product_unit_type\""},
	ProductIdentity:      whereHelpernull_String{field: "\"ttn_products\".\"product_identity\""},
	ProductQuantity:      whereHelpernull_String{field: "\"ttn_products\".\"product_quantity\""},
	ProductPrice:         whereHelpernull_String{field: "\"ttn_products\".\"product_price\""},
	ProductParty:         whereHelpernull_String{field: "\"ttn_products\".\"product_party\""},
	ProductPackID:        whereHelpernull_String{field: "\"ttn_products\".\"product_pack_id\""},
	ProductInformF1RegID: whereHelpernull_String{field: "\"ttn_products\".\"product_inform_f1_reg_id\""},
	ProductInformF2RegID: whereHelpernull_String{field: "\"ttn_products\".\"product_inform_f2_reg_id\""},
	ProducerType:         whereHelpernull_String{field: "\"ttn_products\".\"producer_type\""},
	ProducerClientRegID:  whereHelpernull_String{field: "\"ttn_products\".\"producer_client_reg_id\""},
	ProducerInn:          whereHelpernull_String{field: "\"ttn_products\".\"producer_inn\""},
	ProducerKPP:          whereHelpernull_String{field: "\"ttn_products\".\"producer_kpp\""},
	ProducerFullName:     whereHelpernull_String{field: "\"ttn_products\".\"producer_full_name\""},
	ProducerShortName:    whereHelpernull_String{field: "\"ttn_products\".\"producer_short_name\""},
	ProducerCountryCode:  whereHelpernull_String{field: "\"ttn_products\".\"producer_country_code\""},
	ProducerRegionCode:   whereHelpernull_String{field: "\"ttn_products\".\"producer_region_code\""},
	ProducerDescription:  whereHelpernull_String{field: "\"ttn_products\".\"producer_description\""},
}
...
var (
	...
	ttnProductColumnsWithoutDefault = []string{}
...
func TTNProducts(mods ...qm.QueryMod) ttnProductQuery {
	mods = append(mods, qm.From("\"ttn_products\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ttn_products\".*"})
	}
...
func FindTTNProductG(ctx context.Context, iD int64, selectCols ...string) (*TTNProduct, error) {
...
func FindTTNProduct(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*TTNProduct, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"ttn_products\" where \"id\"=?", sel,
	)
...
func (o *TTNProduct) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ttn_products\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ttn_products\" %sDEFAULT VALUES%s"
		}
...
func (o *TTNProduct) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ttn_products\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, ttnProductPrimaryKeyColumns),
		)
...
func (o TTNProductSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ttn_products\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnProductPrimaryKeyColumns, len(o)))
...
func (o *TTNProduct) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TTNProduct) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(ttnProductPrimaryKeyColumns))
			copy(conflict, ttnProductPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"ttn_products\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(ttnProductType, ttnProductMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *TTNProduct) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_products\" WHERE \"id\"=?"
...
func (o TTNProductSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_products\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnProductPrimaryKeyColumns, len(o))
...
func (o *TTNProductSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"ttn_products\".* FROM \"ttn_products\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnProductPrimaryKeyColumns, len(*o))
...
func TTNProductExistsG(ctx context.Context, iD int64) (bool, error) {
	return TTNProductExists(ctx, boil.GetContextDB(), iD)
}

// TTNProductExists checks if the TTNProduct row exists.
func TTNProductExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ttn_products\" where \"id\"=? limit 1)"
