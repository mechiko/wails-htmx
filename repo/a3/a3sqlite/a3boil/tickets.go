...
var TicketWhere = struct {
	...
	Identity:          whereHelpernull_String{field: "\"tickets\".\"identity\""},
...
var (
	...
	ticketColumnsWithDefault    = []string{"id", "ticket_date", "identity", "doc_id", "transport_id", "reg_id", "doc_hash", "doc_type", "conclusion", "conclusion_date", "conclusion_comment", "operation_name", "operation_result", "operation_date", "operation_comment", "xml_reply"}
