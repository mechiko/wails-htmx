...
var TTNForm2ContentWhere = struct {
	...
	ProductIdentity:      whereHelpernull_String{field: "\"ttn_form2_content\".\"product_identity\""},
...
var (
	...
	ttnForm2ContentColumnsWithDefault    = []string{"id", "id_ttn_form2", "product_identity", "product_inform_f2_reg_id", "bottling_date"}
