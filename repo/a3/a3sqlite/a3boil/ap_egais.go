...
var ApEgaisWhere = struct {
	...
	ID:                  whereHelperint64{field: "\"ap_egais\".\"id\""},
	IDRequests:          whereHelpernull_Int64{field: "\"ap_egais\".\"id_requests\""},
	ProductFullName:     whereHelpernull_String{field: "\"ap_egais\".\"product_full_name\""},
	ProductCapacity:     whereHelpernull_String{field: "\"ap_egais\".\"product_capacity\""},
	ProductAlcVolume:    whereHelpernull_String{field: "\"ap_egais\".\"product_alc_volume\""},
	ProductAlcCode:      whereHelpernull_String{field: "\"ap_egais\".\"product_alc_code\""},
	ProductCode:         whereHelpernull_String{field: "\"ap_egais\".\"product_code\""},
	ProductUnitType:     whereHelpernull_String{field: "\"ap_egais\".\"product_unit_type\""},
	ProducerType:        whereHelpernull_String{field: "\"ap_egais\".\"producer_type\""},
	ProducerClientRegID: whereHelpernull_String{field: "\"ap_egais\".\"producer_client_reg_id\""},
	ProducerInn:         whereHelpernull_String{field: "\"ap_egais\".\"producer_inn\""},
	ProducerKPP:         whereHelpernull_String{field: "\"ap_egais\".\"producer_kpp\""},
	ProducerFullName:    whereHelpernull_String{field: "\"ap_egais\".\"producer_full_name\""},
	ProducerShortName:   whereHelpernull_String{field: "\"ap_egais\".\"producer_short_name\""},
	ProducerCountryCode: whereHelpernull_String{field: "\"ap_egais\".\"producer_country_code\""},
	ProducerRegionCode:  whereHelpernull_String{field: "\"ap_egais\".\"producer_region_code\""},
	ProducerDescription: whereHelpernull_String{field: "\"ap_egais\".\"producer_description\""},
}
...
var (
	...
	apEgaisColumnsWithoutDefault = []string{}
	apEgaisColumnsWithDefault    = []string{"id", "id_requests", "product_full_name", "product_capacity", "product_alc_volume", "product_alc_code", "product_code", "product_unit_type", "producer_type", "producer_client_reg_id", "producer_inn", "producer_kpp", "producer_full_name", "producer_short_name", "producer_country_code", "producer_region_code", "producer_description"}
...
func ApEgaiss(mods ...qm.QueryMod) apEgaisQuery {
	mods = append(mods, qm.From("\"ap_egais\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ap_egais\".*"})
	}
...
func FindApEgaisG(ctx context.Context, iD int64, selectCols ...string) (*ApEgais, error) {
...
func FindApEgais(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ApEgais, error) {
	apEgaisObj := &ApEgais{}
	...
	query := fmt.Sprintf(
		"select %s from \"ap_egais\" where \"id\"=?", sel,
	)
...
func (o *ApEgais) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ap_egais\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ap_egais\" %sDEFAULT VALUES%s"
		}
...
func (o *ApEgais) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ap_egais\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, apEgaisPrimaryKeyColumns),
		)
...
func (o ApEgaisSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ap_egais\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, apEgaisPrimaryKeyColumns, len(o)))
...
func (o *ApEgais) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *ApEgais) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(apEgaisPrimaryKeyColumns))
			copy(conflict, apEgaisPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"ap_egais\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(apEgaisType, apEgaisMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *ApEgais) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ap_egais\" WHERE \"id\"=?"
...
func (o ApEgaisSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ap_egais\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, apEgaisPrimaryKeyColumns, len(o))
...
func (o *ApEgaisSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"ap_egais\".* FROM \"ap_egais\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, apEgaisPrimaryKeyColumns, len(*o))
...
func ApEgaisExistsG(ctx context.Context, iD int64) (bool, error) {
	return ApEgaisExists(ctx, boil.GetContextDB(), iD)
}

// ApEgaisExists checks if the ApEgais row exists.
func ApEgaisExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ap_egais\" where \"id\"=? limit 1)"
