...
type TTNHistoriesContent struct {
	...
	IDTTNHistories     null.Int64  `boil:"id_ttn_histories" json:"id_ttn_histories,omitempty" toml:"id_ttn_histories" yaml:"id_ttn_histories,omitempty"`
...
var TTNHistoriesContentWhere = struct {
	ID                 whereHelperint64
	IDTTNHistories     whereHelpernull_Int64
	...
	ID:                 whereHelperint64{field: "\"ttn_histories_content\".\"id\""},
	IDTTNHistories:     whereHelpernull_Int64{field: "\"ttn_histories_content\".\"id_ttn_histories\""},
	Level:              whereHelpernull_String{field: "\"ttn_histories_content\".\"level\""},
	ProductForm2:       whereHelpernull_String{field: "\"ttn_histories_content\".\"product_form2\""},
	ProductForm2Parent: whereHelpernull_String{field: "\"ttn_histories_content\".\"product_form2_parent\""},
	ProductQuantity:    whereHelpernull_String{field: "\"ttn_histories_content\".\"product_quantity\""},
	TTNShipper:         whereHelpernull_String{field: "\"ttn_histories_content\".\"ttn_shipper\""},
	TTNConsignee:       whereHelpernull_String{field: "\"ttn_histories_content\".\"ttn_consignee\""},
	TTNRegID:           whereHelpernull_String{field: "\"ttn_histories_content\".\"ttn_reg_id\""},
}
...
var (
	...
	ttnHistoriesContentColumnsWithoutDefault = []string{}
	ttnHistoriesContentColumnsWithDefault    = []string{"id", "id_ttn_histories", "level", "product_form2", "product_form2_parent", "product_quantity", "ttn_shipper", "ttn_consignee", "ttn_reg_id"}
...
func TTNHistoriesContents(mods ...qm.QueryMod) ttnHistoriesContentQuery {
	mods = append(mods, qm.From("\"ttn_histories_content\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ttn_histories_content\".*"})
	}
...
func FindTTNHistoriesContentG(ctx context.Context, iD int64, selectCols ...string) (*TTNHistoriesContent, error) {
...
func FindTTNHistoriesContent(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*TTNHistoriesContent, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"ttn_histories_content\" where \"id\"=?", sel,
	)
...
func (o *TTNHistoriesContent) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ttn_histories_content\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ttn_histories_content\" %sDEFAULT VALUES%s"
		}
...
func (o *TTNHistoriesContent) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ttn_histories_content\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, ttnHistoriesContentPrimaryKeyColumns),
		)
...
func (o TTNHistoriesContentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ttn_histories_content\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnHistoriesContentPrimaryKeyColumns, len(o)))
...
func (o *TTNHistoriesContent) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TTNHistoriesContent) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(ttnHistoriesContentPrimaryKeyColumns))
			copy(conflict, ttnHistoriesContentPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"ttn_histories_content\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(ttnHistoriesContentType, ttnHistoriesContentMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *TTNHistoriesContent) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_histories_content\" WHERE \"id\"=?"
...
func (o TTNHistoriesContentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_histories_content\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnHistoriesContentPrimaryKeyColumns, len(o))
...
func (o *TTNHistoriesContentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"ttn_histories_content\".* FROM \"ttn_histories_content\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnHistoriesContentPrimaryKeyColumns, len(*o))
...
func TTNHistoriesContentExistsG(ctx context.Context, iD int64) (bool, error) {
...
func TTNHistoriesContentExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ttn_histories_content\" where \"id\"=? limit 1)"
