...
var ProductionForm1ContentWhere = struct {
	...
	ProductIdentity:      whereHelpernull_String{field: "\"production_form1_content\".\"product_identity\""},
...
var (
	...
	productionForm1ContentColumnsWithDefault    = []string{"id", "id_production_form1", "product_identity", "product_inform_f1_reg_id", "product_inform_f2_reg_id"}
