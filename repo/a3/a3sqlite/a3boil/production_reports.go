...
var ProductionReportWhere = struct {
	...
	DocIddomain:         whereHelpernull_String{field: "\"production_reports\".\"doc_iddomain\""},
...
var (
	...
	productionReportColumnsWithDefault    = []string{"id", "create_date", "doc_iddomain", "doc_type", "doc_number", "doc_date", "doc_produced_date", "doc_comment", "producer_type", "producer_client_reg_id", "producer_inn", "producer_kpp", "producer_full_name", "producer_short_name", "producer_country_code", "producer_region_code", "producer_description", "version", "state", "status", "reply_id", "archive", "xml"}
