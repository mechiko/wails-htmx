...
var ProductionReportWhere = struct {
	...
	ID:                  whereHelperint64{field: "\"production_reports\".\"id\""},
	CreateDate:          whereHelpernull_String{field: "\"production_reports\".\"create_date\""},
	DocIdentity:         whereHelpernull_String{field: "\"production_reports\".\"doc_identity\""},
	DocType:             whereHelpernull_String{field: "\"production_reports\".\"doc_type\""},
	DocNumber:           whereHelpernull_String{field: "\"production_reports\".\"doc_number\""},
	DocDate:             whereHelpernull_String{field: "\"production_reports\".\"doc_date\""},
	DocProducedDate:     whereHelpernull_String{field: "\"production_reports\".\"doc_produced_date\""},
	DocComment:          whereHelpernull_String{field: "\"production_reports\".\"doc_comment\""},
	ProducerType:        whereHelpernull_String{field: "\"production_reports\".\"producer_type\""},
	ProducerClientRegID: whereHelpernull_String{field: "\"production_reports\".\"producer_client_reg_id\""},
	ProducerInn:         whereHelpernull_String{field: "\"production_reports\".\"producer_inn\""},
	ProducerKPP:         whereHelpernull_String{field: "\"production_reports\".\"producer_kpp\""},
	ProducerFullName:    whereHelpernull_String{field: "\"production_reports\".\"producer_full_name\""},
	ProducerShortName:   whereHelpernull_String{field: "\"production_reports\".\"producer_short_name\""},
	ProducerCountryCode: whereHelpernull_String{field: "\"production_reports\".\"producer_country_code\""},
	ProducerRegionCode:  whereHelpernull_String{field: "\"production_reports\".\"producer_region_code\""},
	ProducerDescription: whereHelpernull_String{field: "\"production_reports\".\"producer_description\""},
	Version:             whereHelpernull_String{field: "\"production_reports\".\"version\""},
	State:               whereHelpernull_String{field: "\"production_reports\".\"state\""},
	Status:              whereHelpernull_String{field: "\"production_reports\".\"status\""},
	ReplyID:             whereHelpernull_String{field: "\"production_reports\".\"reply_id\""},
	Archive:             whereHelpernull_Int64{field: "\"production_reports\".\"archive\""},
	XML:                 whereHelpernull_String{field: "\"production_reports\".\"xml\""},
}
...
var (
	...
	productionReportColumnsWithoutDefault = []string{}
	productionReportColumnsWithDefault    = []string{"id", "create_date", "doc_identity", "doc_type", "doc_number", "doc_date", "doc_produced_date", "doc_comment", "producer_type", "producer_client_reg_id", "producer_inn", "producer_kpp", "producer_full_name", "producer_short_name", "producer_country_code", "producer_region_code", "producer_description", "version", "state", "status", "reply_id", "archive", "xml"}
...
func ProductionReports(mods ...qm.QueryMod) productionReportQuery {
	mods = append(mods, qm.From("\"production_reports\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"production_reports\".*"})
	}
...
func FindProductionReportG(ctx context.Context, iD int64, selectCols ...string) (*ProductionReport, error) {
...
func FindProductionReport(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ProductionReport, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"production_reports\" where \"id\"=?", sel,
	)
...
func (o *ProductionReport) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"production_reports\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"production_reports\" %sDEFAULT VALUES%s"
		}
...
func (o *ProductionReport) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"production_reports\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, productionReportPrimaryKeyColumns),
		)
...
func (o ProductionReportSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"production_reports\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productionReportPrimaryKeyColumns, len(o)))
...
func (o *ProductionReport) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *ProductionReport) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(productionReportPrimaryKeyColumns))
			copy(conflict, productionReportPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"production_reports\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(productionReportType, productionReportMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *ProductionReport) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"production_reports\" WHERE \"id\"=?"
...
func (o ProductionReportSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"production_reports\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productionReportPrimaryKeyColumns, len(o))
...
func (o *ProductionReportSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"production_reports\".* FROM \"production_reports\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productionReportPrimaryKeyColumns, len(*o))
...
func ProductionReportExistsG(ctx context.Context, iD int64) (bool, error) {
	return ProductionReportExists(ctx, boil.GetContextDB(), iD)
}

// ProductionReportExists checks if the ProductionReport row exists.
func ProductionReportExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"production_reports\" where \"id\"=? limit 1)"
