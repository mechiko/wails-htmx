...
var ChargeOnForm1Where = struct {
	...
	DocIdentity:    whereHelpernull_String{field: "\"charge_on_form1\".\"doc_identity\""},
...
var (
	...
	chargeOnForm1ColumnsWithDefault    = []string{"id", "id_charge_on_acts", "doc_identity", "doc_reg_id", "doc_number", "xml"}
