...
var ChargeOnActWhere = struct {
	...
	DocIddomain:      whereHelpernull_String{field: "\"charge_on_acts\".\"doc_iddomain\""},
...
var (
	...
	chargeOnActColumnsWithDefault    = []string{"id", "create_date", "doc_iddomain", "doc_type", "doc_number", "doc_date", "doc_comment", "write_off_act_reg_id", "version", "state", "status", "reply_id", "archive", "xml"}
