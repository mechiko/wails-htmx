...
var Form1EgaisWhere = struct {
	...
	ID:                   whereHelperint{field: "[dbo].[form1_egais].[id]"},
	IDRequests:           whereHelpernull_Int{field: "[dbo].[form1_egais].[id_requests]"},
	OriginalDocNumber:    whereHelpernull_String{field: "[dbo].[form1_egais].[original_doc_number]"},
	OriginalDocDate:      whereHelpernull_String{field: "[dbo].[form1_egais].[original_doc_date]"},
	BottlingDate:         whereHelpernull_String{field: "[dbo].[form1_egais].[bottling_date]"},
	EgaisNumber:          whereHelpernull_String{field: "[dbo].[form1_egais].[egais_number]"},
	EgaisDate:            whereHelpernull_String{field: "[dbo].[form1_egais].[egais_date]"},
	GTDNumber:            whereHelpernull_String{field: "[dbo].[form1_egais].[gtd_number]"},
	GTDDate:              whereHelpernull_String{field: "[dbo].[form1_egais].[gtd_date]"},
	ClientType:           whereHelpernull_String{field: "[dbo].[form1_egais].[client_type]"},
	ClientRegID:          whereHelpernull_String{field: "[dbo].[form1_egais].[client_reg_id]"},
	ClientInn:            whereHelpernull_String{field: "[dbo].[form1_egais].[client_inn]"},
	ClientKPP:            whereHelpernull_String{field: "[dbo].[form1_egais].[client_kpp]"},
	ClientFullName:       whereHelpernull_String{field: "[dbo].[form1_egais].[client_full_name]"},
	ClientShortName:      whereHelpernull_String{field: "[dbo].[form1_egais].[client_short_name]"},
	ClientCountryCode:    whereHelpernull_String{field: "[dbo].[form1_egais].[client_country_code]"},
	ClientRegionCode:     whereHelpernull_String{field: "[dbo].[form1_egais].[client_region_code]"},
	ClientDescription:    whereHelpernull_String{field: "[dbo].[form1_egais].[client_description]"},
	ProductFullName:      whereHelpernull_String{field: "[dbo].[form1_egais].[product_full_name]"},
	ProductCapacity:      whereHelpernull_String{field: "[dbo].[form1_egais].[product_capacity]"},
	ProductAlcVolume:     whereHelpernull_String{field: "[dbo].[form1_egais].[product_alc_volume]"},
	ProductAlcCode:       whereHelpernull_String{field: "[dbo].[form1_egais].[product_alc_code]"},
	ProductCode:          whereHelpernull_String{field: "[dbo].[form1_egais].[product_code]"},
	ProductUnitType:      whereHelpernull_String{field: "[dbo].[form1_egais].[product_unit_type]"},
	ProductQuantity:      whereHelpernull_String{field: "[dbo].[form1_egais].[product_quantity]"},
	ProductInformF1RegID: whereHelpernull_String{field: "[dbo].[form1_egais].[product_inform_f1_reg_id]"},
	ProducerType:         whereHelpernull_String{field: "[dbo].[form1_egais].[producer_type]"},
	ProducerClientRegID:  whereHelpernull_String{field: "[dbo].[form1_egais].[producer_client_reg_id]"},
	ProducerInn:          whereHelpernull_String{field: "[dbo].[form1_egais].[producer_inn]"},
	ProducerKPP:          whereHelpernull_String{field: "[dbo].[form1_egais].[producer_kpp]"},
	ProducerFullName:     whereHelpernull_String{field: "[dbo].[form1_egais].[producer_full_name]"},
	ProducerShortName:    whereHelpernull_String{field: "[dbo].[form1_egais].[producer_short_name]"},
	ProducerCountryCode:  whereHelpernull_String{field: "[dbo].[form1_egais].[producer_country_code]"},
	ProducerRegionCode:   whereHelpernull_String{field: "[dbo].[form1_egais].[producer_region_code]"},
	ProducerDescription:  whereHelpernull_String{field: "[dbo].[form1_egais].[producer_description]"},
}
...
var (
	...
	form1EgaisColumnsWithoutDefault = []string{"id_requests", "original_doc_number", "original_doc_date", "bottling_date", "egais_number", "egais_date", "gtd_number", "gtd_date", "client_type", "client_reg_id", "client_inn", "client_kpp", "client_full_name", "client_short_name", "client_country_code", "client_region_code", "client_description", "product_full_name", "product_capacity", "product_alc_volume", "product_alc_code", "product_code", "product_unit_type", "product_quantity", "product_inform_f1_reg_id", "producer_type", "producer_client_reg_id", "producer_inn", "producer_kpp", "producer_full_name", "producer_short_name", "producer_country_code", "producer_region_code", "producer_description"}
	form1EgaisColumnsWithDefault    = []string{"id"}
...
func Form1Egaiss(mods ...qm.QueryMod) form1EgaisQuery {
	mods = append(mods, qm.From("[dbo].[form1_egais]"))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"[dbo].[form1_egais].*"})
	}
...
func FindForm1EgaisG(ctx context.Context, iD int, selectCols ...string) (*Form1Egais, error) {
...
func FindForm1Egais(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Form1Egais, error) {
	...
	query := fmt.Sprintf(
		"select %s from [dbo].[form1_egais] where [id]=$1", sel,
	)
...
func (o *Form1Egais) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO [dbo].[form1_egais] ([%s]) %%sVALUES (%s)%%s", strings.Join(wl, "],["), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO [dbo].[form1_egais] %sDEFAULT VALUES%s"
		}
...
func (o *Form1Egais) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE [dbo].[form1_egais] SET %s WHERE %s",
			strmangle.SetParamNames("[", "]", 1, wl),
			strmangle.WhereClause("[", "]", len(wl)+1, form1EgaisPrimaryKeyColumns),
		)
...
func (o Form1EgaisSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE [dbo].[form1_egais] SET %s WHERE %s",
		strmangle.SetParamNames("[", "]", 1, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), len(colNames)+1, form1EgaisPrimaryKeyColumns, len(o)))
...
func (o *Form1Egais) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
func (o *Form1Egais) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, form1EgaisGeneratedColumns)

		for i, v := range insert {
			if strmangle.ContainsAny(form1EgaisPrimaryKeyColumns, v) && strmangle.ContainsAny(form1EgaisColumnsWithDefault, v) {
				insert = append(insert[:i], insert[i+1:]...)
			}
		}
		if len(insert) == 0 {
			return errors.New("a3boil: unable to upsert form1_egais, could not build insert column list")
		}
		...
		ret := strmangle.SetComplement(form1EgaisAllColumns, strmangle.SetIntersect(insert, update))

		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("a3boil: unable to upsert form1_egais, could not build update column list")
		}

		cache.query = buildUpsertQueryMSSQL(dialect, "[dbo].[form1_egais]", form1EgaisPrimaryKeyColumns, update, insert, ret)

		whitelist := make([]string, len(form1EgaisPrimaryKeyColumns))
		copy(whitelist, form1EgaisPrimaryKeyColumns)
		whitelist = append(whitelist, update...)
		whitelist = append(whitelist, insert...)

		cache.valueMapping, err = queries.BindMapping(form1EgaisType, form1EgaisMapping, whitelist)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *Form1Egais) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM [dbo].[form1_egais] WHERE [id]=$1"
...
func (o Form1EgaisSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM [dbo].[form1_egais] WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, form1EgaisPrimaryKeyColumns, len(o))
...
func (o *Form1EgaisSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT [dbo].[form1_egais].* FROM [dbo].[form1_egais] WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, form1EgaisPrimaryKeyColumns, len(*o))
...
func Form1EgaisExistsG(ctx context.Context, iD int) (bool, error) {
	return Form1EgaisExists(ctx, boil.GetContextDB(), iD)
}

// Form1EgaisExists checks if the Form1Egais row exists.
func Form1EgaisExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select case when exists(select top(1) 1 from [dbo].[form1_egais] where [id]=$1) then 1 else 0 end"
