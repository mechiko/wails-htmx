...
var ProductionGrapeWhere = struct {
	...
	GrapeIdentity:        whereHelpernull_String{field: "[dbo].[production_grapes].[grape_identity]"},
...
var (
	...
	productionGrapeColumnsWithoutDefault = []string{"id_production_reports", "id_production_products", "grape_sort", "grape_code", "grape_weight", "vineyard_number", "receipt_date", "grape_identity", "supplier_type", "supplier_client_reg_id", "supplier_inn", "supplier_kpp", "supplier_full_name", "supplier_short_name", "supplier_country_code", "supplier_region_code", "supplier_description"}
