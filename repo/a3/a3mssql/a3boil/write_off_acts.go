...
var WriteOffActWhere = struct {
	...
	DocIdentity: whereHelpernull_String{field: "[dbo].[write_off_acts].[doc_identity]"},
...
var (
	...
	writeOffActColumnsWithoutDefault = []string{"create_date", "doc_identity", "doc_type", "doc_number", "doc_date", "doc_comment", "version", "state", "status", "reply_id", "archive", "xml"}
