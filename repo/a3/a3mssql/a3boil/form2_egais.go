...
var Form2EgaisWhere = struct {
	...
	ID:                   whereHelperint{field: "[dbo].[form2_egais].[id]"},
	IDRequests:           whereHelpernull_Int{field: "[dbo].[form2_egais].[id_requests]"},
	TTNNumber:            whereHelpernull_String{field: "[dbo].[form2_egais].[ttn_number]"},
	TTNDate:              whereHelpernull_String{field: "[dbo].[form2_egais].[ttn_date]"},
	ShippingDate:         whereHelpernull_String{field: "[dbo].[form2_egais].[shipping_date]"},
	ShipperType:          whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_type]"},
	ShipperClientRegID:   whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_client_reg_id]"},
	ShipperInn:           whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_inn]"},
	ShipperKPP:           whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_kpp]"},
	ShipperFullName:      whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_full_name]"},
	ShipperShortName:     whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_short_name]"},
	ShipperCountryCode:   whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_country_code]"},
	ShipperRegionCode:    whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_region_code]"},
	ShipperDescription:   whereHelpernull_String{field: "[dbo].[form2_egais].[shipper_description]"},
	ConsigneeType:        whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_type]"},
	ConsigneeClientRegID: whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_client_reg_id]"},
	ConsigneeInn:         whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_inn]"},
	ConsigneeKPP:         whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_kpp]"},
	ConsigneeFullName:    whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_full_name]"},
	ConsigneeShortName:   whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_short_name]"},
	ConsigneeCountryCode: whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_country_code]"},
	ConsigneeRegionCode:  whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_region_code]"},
	ConsigneeDescription: whereHelpernull_String{field: "[dbo].[form2_egais].[consignee_description]"},
	ProductFullName:      whereHelpernull_String{field: "[dbo].[form2_egais].[product_full_name]"},
	ProductCapacity:      whereHelpernull_String{field: "[dbo].[form2_egais].[product_capacity]"},
	ProductAlcVolume:     whereHelpernull_String{field: "[dbo].[form2_egais].[product_alc_volume]"},
	ProductAlcCode:       whereHelpernull_String{field: "[dbo].[form2_egais].[product_alc_code]"},
	ProductCode:          whereHelpernull_String{field: "[dbo].[form2_egais].[product_code]"},
	ProductUnitType:      whereHelpernull_String{field: "[dbo].[form2_egais].[product_unit_type]"},
	ProductQuantity:      whereHelpernull_String{field: "[dbo].[form2_egais].[product_quantity]"},
	ProductInformF2RegID: whereHelpernull_String{field: "[dbo].[form2_egais].[product_inform_f2_reg_id]"},
	ProducerType:         whereHelpernull_String{field: "[dbo].[form2_egais].[producer_type]"},
	ProducerClientRegID:  whereHelpernull_String{field: "[dbo].[form2_egais].[producer_client_reg_id]"},
	ProducerInn:          whereHelpernull_String{field: "[dbo].[form2_egais].[producer_inn]"},
	ProducerKPP:          whereHelpernull_String{field: "[dbo].[form2_egais].[producer_kpp]"},
	ProducerFullName:     whereHelpernull_String{field: "[dbo].[form2_egais].[producer_full_name]"},
	ProducerShortName:    whereHelpernull_String{field: "[dbo].[form2_egais].[producer_short_name]"},
	ProducerCountryCode:  whereHelpernull_String{field: "[dbo].[form2_egais].[producer_country_code]"},
	ProducerRegionCode:   whereHelpernull_String{field: "[dbo].[form2_egais].[producer_region_code]"},
	ProducerDescription:  whereHelpernull_String{field: "[dbo].[form2_egais].[producer_description]"},
}
...
var (
	...
	form2EgaisColumnsWithoutDefault = []string{"id_requests", "ttn_number", "ttn_date", "shipping_date", "shipper_type", "shipper_client_reg_id", "shipper_inn", "shipper_kpp", "shipper_full_name", "shipper_short_name", "shipper_country_code", "shipper_region_code", "shipper_description", "consignee_type", "consignee_client_reg_id", "consignee_inn", "consignee_kpp", "consignee_full_name", "consignee_short_name", "consignee_country_code", "consignee_region_code", "consignee_description", "product_full_name", "product_capacity", "product_alc_volume", "product_alc_code", "product_code", "product_unit_type", "product_quantity", "product_inform_f2_reg_id", "producer_type", "producer_client_reg_id", "producer_inn", "producer_kpp", "producer_full_name", "producer_short_name", "producer_country_code", "producer_region_code", "producer_description"}
	form2EgaisColumnsWithDefault    = []string{"id"}
...
func Form2Egaiss(mods ...qm.QueryMod) form2EgaisQuery {
	mods = append(mods, qm.From("[dbo].[form2_egais]"))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"[dbo].[form2_egais].*"})
	}
...
func FindForm2EgaisG(ctx context.Context, iD int, selectCols ...string) (*Form2Egais, error) {
...
func FindForm2Egais(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Form2Egais, error) {
	...
	query := fmt.Sprintf(
		"select %s from [dbo].[form2_egais] where [id]=$1", sel,
	)
...
func (o *Form2Egais) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO [dbo].[form2_egais] ([%s]) %%sVALUES (%s)%%s", strings.Join(wl, "],["), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO [dbo].[form2_egais] %sDEFAULT VALUES%s"
		}
...
func (o *Form2Egais) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE [dbo].[form2_egais] SET %s WHERE %s",
			strmangle.SetParamNames("[", "]", 1, wl),
			strmangle.WhereClause("[", "]", len(wl)+1, form2EgaisPrimaryKeyColumns),
		)
...
func (o Form2EgaisSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE [dbo].[form2_egais] SET %s WHERE %s",
		strmangle.SetParamNames("[", "]", 1, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), len(colNames)+1, form2EgaisPrimaryKeyColumns, len(o)))
...
func (o *Form2Egais) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
func (o *Form2Egais) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, form2EgaisGeneratedColumns)

		for i, v := range insert {
			if strmangle.ContainsAny(form2EgaisPrimaryKeyColumns, v) && strmangle.ContainsAny(form2EgaisColumnsWithDefault, v) {
				insert = append(insert[:i], insert[i+1:]...)
			}
		}
		if len(insert) == 0 {
			return errors.New("a3boil: unable to upsert form2_egais, could not build insert column list")
		}
		...
		ret := strmangle.SetComplement(form2EgaisAllColumns, strmangle.SetIntersect(insert, update))

		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("a3boil: unable to upsert form2_egais, could not build update column list")
		}

		cache.query = buildUpsertQueryMSSQL(dialect, "[dbo].[form2_egais]", form2EgaisPrimaryKeyColumns, update, insert, ret)

		whitelist := make([]string, len(form2EgaisPrimaryKeyColumns))
		copy(whitelist, form2EgaisPrimaryKeyColumns)
		whitelist = append(whitelist, update...)
		whitelist = append(whitelist, insert...)

		cache.valueMapping, err = queries.BindMapping(form2EgaisType, form2EgaisMapping, whitelist)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *Form2Egais) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM [dbo].[form2_egais] WHERE [id]=$1"
...
func (o Form2EgaisSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM [dbo].[form2_egais] WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, form2EgaisPrimaryKeyColumns, len(o))
...
func (o *Form2EgaisSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT [dbo].[form2_egais].* FROM [dbo].[form2_egais] WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, form2EgaisPrimaryKeyColumns, len(*o))
...
func Form2EgaisExistsG(ctx context.Context, iD int) (bool, error) {
	return Form2EgaisExists(ctx, boil.GetContextDB(), iD)
}

// Form2EgaisExists checks if the Form2Egais row exists.
func Form2EgaisExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select case when exists(select top(1) 1 from [dbo].[form2_egais] where [id]=$1) then 1 else 0 end"
