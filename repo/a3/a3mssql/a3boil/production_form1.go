...
var ProductionForm1Where = struct {
	...
	DocIddomain:         whereHelpernull_String{field: "[dbo].[production_form1].[doc_iddomain]"},
...
var (
	...
	productionForm1ColumnsWithoutDefault = []string{"id_production_reports", "doc_iddomain", "doc_reg_id", "client_type", "client_reg_id", "client_inn", "client_kpp", "client_full_name", "client_short_name", "client_country_code", "client_region_code", "client_description", "xml"}
