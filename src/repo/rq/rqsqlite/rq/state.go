...
var StateWhere = struct {
	...
	ID:    whereHelperint64{field: "\"state\".\"id\""},
	State: whereHelpernull_String{field: "\"state\".\"state\""},
	Rem:   whereHelpernull_String{field: "\"state\".\"rem\""},
}
...
var (
	stateAllColumns            = []string{"id", "state", "rem"}
	stateColumnsWithoutDefault = []string{}
	stateColumnsWithDefault    = []string{"id", "state", "rem"}
	statePrimaryKeyColumns     = []string{"id"}
	stateGeneratedColumns      = []string{"id"}
)
...
func (q stateQuery) One(ctx context.Context, exec boil.ContextExecutor) (*State, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "rq: failed to execute a one query for state")
	}
...
func (q stateQuery) All(ctx context.Context, exec boil.ContextExecutor) (StateSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "rq: failed to assign all query results to State slice")
	}
...
func (q stateQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rq: failed to count state rows")
	}
...
func (q stateQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "rq: failed to check if state exists")
	}
...
func FindStateG(ctx context.Context, iD int64, selectCols ...string) (*State, error) {
	return FindState(ctx, boil.GetContextDB(), iD, selectCols...)
}

// FindState retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindState(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*State, error) {
	stateObj := &State{}
	...
	query := fmt.Sprintf(
		"select %s from \"state\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "rq: unable to select from state")
	}
...
func (o *State) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("rq: no state provided for insertion")
	}
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, stateGeneratedColumns)
	...
	if err != nil {
		return errors.Wrap(err, "rq: unable to insert into state")
	}
...
func (o *State) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("rq: unable to update state, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"state\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, statePrimaryKeyColumns),
		)
	...
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to update state row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rq: failed to get rows affected by update for state")
	}
...
func (q stateQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to update all for state")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to retrieve rows affected for state")
	}
...
func (o StateSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"state\" SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, statePrimaryKeyColumns, len(o)))
	...
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to update all in state slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to retrieve rows affected all in update all state")
	}
	return rowsAff, nil
}
...
func (o *State) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("rq: no state provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("rq: unable to upsert state, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"state\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "rq: unable to upsert state")
	}
...
func (o *State) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("rq: no State provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to delete from state")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rq: failed to get rows affected by delete for state")
	}
...
func (q stateQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("rq: no stateQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to delete all from state")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rq: failed to get rows affected by deleteall for state")
	}
...
func (o StateSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "rq: unable to delete all from state slice")
	}
...
func (o *State) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("rq: no State provided for reload")
	}
...
func (o *StateSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("rq: empty StateSlice provided for reload all")
	}
...
func (o *StateSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "rq: unable to reload all in StateSlice")
	}
...
func StateExistsG(ctx context.Context, iD int64) (bool, error) {
	return StateExists(ctx, boil.GetContextDB(), iD)
}

// StateExists checks if the State row exists.
func StateExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"state\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "rq: unable to check if state exists")
	}
