...
func (q dboptionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Dboption, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "liteboil: failed to execute a one query for dboptions")
	}
...
func (q dboptionQuery) All(ctx context.Context, exec boil.ContextExecutor) (DboptionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "liteboil: failed to assign all query results to Dboption slice")
	}
...
func (q dboptionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to count dboptions rows")
	}
...
func (q dboptionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "liteboil: failed to check if dboptions exists")
	}
...
func FindDboption(ctx context.Context, exec boil.ContextExecutor, name string, selectCols ...string) (*Dboption, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "liteboil: unable to select from dboptions")
	}
...
func (o *Dboption) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("liteboil: no dboptions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "liteboil: unable to insert into dboptions")
	}
...
func (o *Dboption) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("liteboil: unable to update dboptions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to update dboptions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to get rows affected by update for dboptions")
	}
...
func (q dboptionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to update all for dboptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to retrieve rows affected for dboptions")
	}
...
func (o DboptionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to update all in dboption slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to retrieve rows affected all in update all dboption")
	}
	return rowsAff, nil
}
...
func (o *Dboption) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("liteboil: no dboptions provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("liteboil: unable to upsert dboptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "liteboil: unable to upsert dboptions")
	}
...
func (o *Dboption) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("liteboil: no Dboption provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to delete from dboptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to get rows affected by delete for dboptions")
	}
...
func (q dboptionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("liteboil: no dboptionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to delete all from dboptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: failed to get rows affected by deleteall for dboptions")
	}
...
func (o DboptionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "liteboil: unable to delete all from dboption slice")
	}
...
func (o *Dboption) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("liteboil: no Dboption provided for reload")
	}
...
func (o *DboptionSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("liteboil: empty DboptionSlice provided for reload all")
	}
...
func (o *DboptionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "liteboil: unable to reload all in DboptionSlice")
	}
...
func DboptionExists(ctx context.Context, exec boil.ContextExecutor, name string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "liteboil: unable to check if dboptions exists")
	}
