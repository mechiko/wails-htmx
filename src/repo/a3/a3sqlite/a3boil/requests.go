...
var RequestWhere = struct {
	...
	ID:         whereHelperint64{field: "\"requests\".\"id\""},
	CreateDate: whereHelpernull_String{field: "\"requests\".\"create_date\""},
	Type:       whereHelpernull_String{field: "\"requests\".\"type\""},
	Name:       whereHelpernull_String{field: "\"requests\".\"name\""},
	Value:      whereHelpernull_String{field: "\"requests\".\"value\""},
	Version:    whereHelpernull_String{field: "\"requests\".\"version\""},
	Status:     whereHelpernull_String{field: "\"requests\".\"status\""},
	ReplyID:    whereHelpernull_String{field: "\"requests\".\"reply_id\""},
	Archive:    whereHelpernull_Int64{field: "\"requests\".\"archive\""},
	XMLQuery:   whereHelpernull_String{field: "\"requests\".\"xml_query\""},
	XMLReply:   whereHelpernull_String{field: "\"requests\".\"xml_reply\""},
}
...
var (
	...
	requestColumnsWithDefault    = []string{"id", "create_date", "type", "name", "value", "version", "status", "reply_id", "archive", "xml_query", "xml_reply"}
...
func FindRequest(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Request, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"requests\" where \"id\"=?", sel,
	)
...
func (o *Request) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"requests\"", updateOnConflict, ret, update, conflict, insert)
...
func RequestExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"requests\" where \"id\"=? limit 1)"
