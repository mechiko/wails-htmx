...
var Form2HistoryEgaisWhere = struct {
	...
	IDRequests:       whereHelpernull_Int64{field: "\"form2_history_egais\".\"id_requests\""},
...
var (
	...
	form2HistoryEgaisColumnsWithoutDefault = []string{}
	form2HistoryEgaisColumnsWithDefault    = []string{"id", "id_requests", "doc_type", "doc_id", "product_quantity", "operation_name", "operation_date", "form2_history_date"}
