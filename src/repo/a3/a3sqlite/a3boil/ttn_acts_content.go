...
var TTNActsContentWhere = struct {
	...
	ProductIddomain:      whereHelpernull_String{field: "\"ttn_acts_content\".\"product_iddomain\""},
...
var (
	...
	ttnActsContentColumnsWithDefault    = []string{"id", "id_ttn_acts", "product_iddomain", "product_inform_f2_reg_id", "product_quantity"}
