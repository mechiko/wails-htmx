...
var TTNProductsPalletWhere = struct {
	...
	ID:            whereHelperint64{field: "\"ttn_products_pallets\".\"id\""},
	IDTTNProducts: whereHelpernull_Int64{field: "\"ttn_products_pallets\".\"id_ttn_products\""},
	PalletNumber:  whereHelpernull_String{field: "\"ttn_products_pallets\".\"pallet_number\""},
}
...
var (
	...
	ttnProductsPalletColumnsWithoutDefault = []string{}
	ttnProductsPalletColumnsWithDefault    = []string{"id", "id_ttn_products", "pallet_number"}
...
func TTNProductsPallets(mods ...qm.QueryMod) ttnProductsPalletQuery {
	mods = append(mods, qm.From("\"ttn_products_pallets\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ttn_products_pallets\".*"})
	}
...
func FindTTNProductsPalletG(ctx context.Context, iD int64, selectCols ...string) (*TTNProductsPallet, error) {
...
func FindTTNProductsPallet(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*TTNProductsPallet, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"ttn_products_pallets\" where \"id\"=?", sel,
	)
...
func (o *TTNProductsPallet) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ttn_products_pallets\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ttn_products_pallets\" %sDEFAULT VALUES%s"
		}
...
func (o *TTNProductsPallet) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ttn_products_pallets\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, ttnProductsPalletPrimaryKeyColumns),
		)
...
func (o TTNProductsPalletSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ttn_products_pallets\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnProductsPalletPrimaryKeyColumns, len(o)))
...
func (o *TTNProductsPallet) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TTNProductsPallet) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(ttnProductsPalletPrimaryKeyColumns))
			copy(conflict, ttnProductsPalletPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"ttn_products_pallets\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(ttnProductsPalletType, ttnProductsPalletMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *TTNProductsPallet) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_products_pallets\" WHERE \"id\"=?"
...
func (o TTNProductsPalletSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ttn_products_pallets\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnProductsPalletPrimaryKeyColumns, len(o))
...
func (o *TTNProductsPalletSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"ttn_products_pallets\".* FROM \"ttn_products_pallets\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, ttnProductsPalletPrimaryKeyColumns, len(*o))
...
func TTNProductsPalletExistsG(ctx context.Context, iD int64) (bool, error) {
...
func TTNProductsPalletExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ttn_products_pallets\" where \"id\"=? limit 1)"
