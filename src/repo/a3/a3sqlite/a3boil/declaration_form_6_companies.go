...
type DeclarationForm6Company struct {
	...
	IDDeclarationForm6 null.Int64  `boil:"id_declaration_form_6" json:"id_declaration_form_6,omitempty" toml:"id_declaration_form_6" yaml:"id_declaration_form_6,omitempty"`
...
var DeclarationForm6CompanyWhere = struct {
	ID                 whereHelperint64
	IDDeclarationForm6 whereHelpernull_Int64
	...
	ID:                 whereHelperint64{field: "\"declaration_form_6_companies\".\"id\""},
	IDDeclarationForm6: whereHelpernull_Int64{field: "\"declaration_form_6_companies\".\"id_declaration_form_6\""},
	Type:               whereHelpernull_String{field: "\"declaration_form_6_companies\".\"type\""},
	FullName:           whereHelpernull_String{field: "\"declaration_form_6_companies\".\"full_name\""},
	Inn:                whereHelpernull_String{field: "\"declaration_form_6_companies\".\"inn\""},
	KPP:                whereHelpernull_String{field: "\"declaration_form_6_companies\".\"kpp\""},
	PostIndex:          whereHelpernull_String{field: "\"declaration_form_6_companies\".\"post_index\""},
	RegionCode:         whereHelpernull_String{field: "\"declaration_form_6_companies\".\"region_code\""},
	District:           whereHelpernull_String{field: "\"declaration_form_6_companies\".\"district\""},
	City:               whereHelpernull_String{field: "\"declaration_form_6_companies\".\"city\""},
	Locality:           whereHelpernull_String{field: "\"declaration_form_6_companies\".\"locality\""},
	Street:             whereHelpernull_String{field: "\"declaration_form_6_companies\".\"street\""},
	House:              whereHelpernull_String{field: "\"declaration_form_6_companies\".\"house\""},
	Building:           whereHelpernull_String{field: "\"declaration_form_6_companies\".\"building\""},
	Letter:             whereHelpernull_String{field: "\"declaration_form_6_companies\".\"letter\""},
	Apartment:          whereHelpernull_String{field: "\"declaration_form_6_companies\".\"apartment\""},
	Phone:              whereHelpernull_String{field: "\"declaration_form_6_companies\".\"phone\""},
	Email:              whereHelpernull_String{field: "\"declaration_form_6_companies\".\"email\""},
}
...
var (
	...
	declarationForm6CompanyColumnsWithoutDefault = []string{}
	declarationForm6CompanyColumnsWithDefault    = []string{"id", "id_declaration_form_6", "type", "full_name", "inn", "kpp", "post_index", "region_code", "district", "city", "locality", "street", "house", "building", "letter", "apartment", "phone", "email"}
...
func DeclarationForm6Companies(mods ...qm.QueryMod) declarationForm6CompanyQuery {
	mods = append(mods, qm.From("\"declaration_form_6_companies\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"declaration_form_6_companies\".*"})
	}
...
func FindDeclarationForm6CompanyG(ctx context.Context, iD int64, selectCols ...string) (*DeclarationForm6Company, error) {
...
func FindDeclarationForm6Company(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*DeclarationForm6Company, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"declaration_form_6_companies\" where \"id\"=?", sel,
	)
...
func (o *DeclarationForm6Company) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"declaration_form_6_companies\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"declaration_form_6_companies\" %sDEFAULT VALUES%s"
		}
...
func (o *DeclarationForm6Company) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"declaration_form_6_companies\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, declarationForm6CompanyPrimaryKeyColumns),
		)
...
func (o DeclarationForm6CompanySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"declaration_form_6_companies\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, declarationForm6CompanyPrimaryKeyColumns, len(o)))
...
func (o *DeclarationForm6Company) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *DeclarationForm6Company) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(declarationForm6CompanyPrimaryKeyColumns))
			copy(conflict, declarationForm6CompanyPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"declaration_form_6_companies\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(declarationForm6CompanyType, declarationForm6CompanyMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *DeclarationForm6Company) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"declaration_form_6_companies\" WHERE \"id\"=?"
...
func (o DeclarationForm6CompanySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"declaration_form_6_companies\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, declarationForm6CompanyPrimaryKeyColumns, len(o))
...
func (o *DeclarationForm6CompanySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"declaration_form_6_companies\".* FROM \"declaration_form_6_companies\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, declarationForm6CompanyPrimaryKeyColumns, len(*o))
...
func DeclarationForm6CompanyExistsG(ctx context.Context, iD int64) (bool, error) {
...
func DeclarationForm6CompanyExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"declaration_form_6_companies\" where \"id\"=? limit 1)"
