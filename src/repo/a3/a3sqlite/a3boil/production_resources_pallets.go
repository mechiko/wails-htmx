...
var ProductionResourcesPalletWhere = struct {
	...
	ID:                    whereHelperint64{field: "\"production_resources_pallets\".\"id\""},
	IDProductionResources: whereHelpernull_Int64{field: "\"production_resources_pallets\".\"id_production_resources\""},
	PalletNumber:          whereHelpernull_String{field: "\"production_resources_pallets\".\"pallet_number\""},
}
...
var (
	...
	productionResourcesPalletColumnsWithoutDefault = []string{}
	productionResourcesPalletColumnsWithDefault    = []string{"id", "id_production_resources", "pallet_number"}
...
func ProductionResourcesPallets(mods ...qm.QueryMod) productionResourcesPalletQuery {
	mods = append(mods, qm.From("\"production_resources_pallets\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"production_resources_pallets\".*"})
	}
...
func FindProductionResourcesPalletG(ctx context.Context, iD int64, selectCols ...string) (*ProductionResourcesPallet, error) {
...
func FindProductionResourcesPallet(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ProductionResourcesPallet, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"production_resources_pallets\" where \"id\"=?", sel,
	)
...
func (o *ProductionResourcesPallet) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"production_resources_pallets\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"production_resources_pallets\" %sDEFAULT VALUES%s"
		}
...
func (o *ProductionResourcesPallet) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"production_resources_pallets\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, productionResourcesPalletPrimaryKeyColumns),
		)
...
func (o ProductionResourcesPalletSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"production_resources_pallets\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productionResourcesPalletPrimaryKeyColumns, len(o)))
...
func (o *ProductionResourcesPallet) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *ProductionResourcesPallet) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(productionResourcesPalletPrimaryKeyColumns))
			copy(conflict, productionResourcesPalletPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"production_resources_pallets\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(productionResourcesPalletType, productionResourcesPalletMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *ProductionResourcesPallet) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"production_resources_pallets\" WHERE \"id\"=?"
...
func (o ProductionResourcesPalletSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"production_resources_pallets\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productionResourcesPalletPrimaryKeyColumns, len(o))
...
func (o *ProductionResourcesPalletSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"production_resources_pallets\".* FROM \"production_resources_pallets\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productionResourcesPalletPrimaryKeyColumns, len(*o))
...
func ProductionResourcesPalletExistsG(ctx context.Context, iD int64) (bool, error) {
...
func ProductionResourcesPalletExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"production_resources_pallets\" where \"id\"=? limit 1)"
