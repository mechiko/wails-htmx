...
var PartnersEgaisWhere = struct {
	...
	ID:                whereHelperint64{field: "\"partners_egais\".\"id\""},
	IDRequests:        whereHelpernull_Int64{field: "\"partners_egais\".\"id_requests\""},
	ClientType:        whereHelpernull_String{field: "\"partners_egais\".\"client_type\""},
	ClientRegID:       whereHelpernull_String{field: "\"partners_egais\".\"client_reg_id\""},
	ClientInn:         whereHelpernull_String{field: "\"partners_egais\".\"client_inn\""},
	ClientKPP:         whereHelpernull_String{field: "\"partners_egais\".\"client_kpp\""},
	ClientFullName:    whereHelpernull_String{field: "\"partners_egais\".\"client_full_name\""},
	ClientShortName:   whereHelpernull_String{field: "\"partners_egais\".\"client_short_name\""},
	ClientCountryCode: whereHelpernull_String{field: "\"partners_egais\".\"client_country_code\""},
	ClientRegionCode:  whereHelpernull_String{field: "\"partners_egais\".\"client_region_code\""},
	ClientDescription: whereHelpernull_String{field: "\"partners_egais\".\"client_description\""},
	ClientState:       whereHelpernull_String{field: "\"partners_egais\".\"client_state\""},
	ClientWBVersion:   whereHelpernull_String{field: "\"partners_egais\".\"client_wb_version\""},
	ClientLicense:     whereHelpernull_String{field: "\"partners_egais\".\"client_license\""},
}
...
var (
	...
	partnersEgaisColumnsWithoutDefault = []string{}
	partnersEgaisColumnsWithDefault    = []string{"id", "id_requests", "client_type", "client_reg_id", "client_inn", "client_kpp", "client_full_name", "client_short_name", "client_country_code", "client_region_code", "client_description", "client_state", "client_wb_version", "client_license"}
...
func PartnersEgaiss(mods ...qm.QueryMod) partnersEgaisQuery {
	mods = append(mods, qm.From("\"partners_egais\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"partners_egais\".*"})
	}
...
func FindPartnersEgaisG(ctx context.Context, iD int64, selectCols ...string) (*PartnersEgais, error) {
...
func FindPartnersEgais(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*PartnersEgais, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"partners_egais\" where \"id\"=?", sel,
	)
...
func (o *PartnersEgais) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"partners_egais\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"partners_egais\" %sDEFAULT VALUES%s"
		}
...
func (o *PartnersEgais) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"partners_egais\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, partnersEgaisPrimaryKeyColumns),
		)
...
func (o PartnersEgaisSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"partners_egais\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, partnersEgaisPrimaryKeyColumns, len(o)))
...
func (o *PartnersEgais) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *PartnersEgais) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(partnersEgaisPrimaryKeyColumns))
			copy(conflict, partnersEgaisPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"partners_egais\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(partnersEgaisType, partnersEgaisMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *PartnersEgais) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"partners_egais\" WHERE \"id\"=?"
...
func (o PartnersEgaisSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"partners_egais\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, partnersEgaisPrimaryKeyColumns, len(o))
...
func (o *PartnersEgaisSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"partners_egais\".* FROM \"partners_egais\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, partnersEgaisPrimaryKeyColumns, len(*o))
...
func PartnersEgaisExistsG(ctx context.Context, iD int64) (bool, error) {
	return PartnersEgaisExists(ctx, boil.GetContextDB(), iD)
}

// PartnersEgaisExists checks if the PartnersEgais row exists.
func PartnersEgaisExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"partners_egais\" where \"id\"=? limit 1)"
