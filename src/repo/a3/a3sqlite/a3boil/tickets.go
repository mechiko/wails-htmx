...
var TicketWhere = struct {
	...
	TicketDate:        whereHelpernull_String{field: "\"tickets\".\"ticket_date\""},
	Iddomain:          whereHelpernull_String{field: "\"tickets\".\"iddomain\""},
	DocID:             whereHelpernull_String{field: "\"tickets\".\"doc_id\""},
	TransportID:       whereHelpernull_String{field: "\"tickets\".\"transport_id\""},
	RegID:             whereHelpernull_String{field: "\"tickets\".\"reg_id\""},
	DocHash:           whereHelpernull_String{field: "\"tickets\".\"doc_hash\""},
	DocType:           whereHelpernull_String{field: "\"tickets\".\"doc_type\""},
	Conclusion:        whereHelpernull_String{field: "\"tickets\".\"conclusion\""},
	ConclusionDate:    whereHelpernull_String{field: "\"tickets\".\"conclusion_date\""},
	ConclusionComment: whereHelpernull_String{field: "\"tickets\".\"conclusion_comment\""},
	OperationName:     whereHelpernull_String{field: "\"tickets\".\"operation_name\""},
	OperationResult:   whereHelpernull_String{field: "\"tickets\".\"operation_result\""},
	OperationDate:     whereHelpernull_String{field: "\"tickets\".\"operation_date\""},
	OperationComment:  whereHelpernull_String{field: "\"tickets\".\"operation_comment\""},
	XMLReply:          whereHelpernull_String{field: "\"tickets\".\"xml_reply\""},
}
...
var (
	...
	ticketColumnsWithDefault    = []string{"id", "ticket_date", "iddomain", "doc_id", "transport_id", "reg_id", "doc_hash", "doc_type", "conclusion", "conclusion_date", "conclusion_comment", "operation_name", "operation_result", "operation_date", "operation_comment", "xml_reply"}
