...
type DeclarationForm6Content struct {
	...
	IDDeclarationForm6Companies null.Int64  `boil:"id_declaration_form_6_companies" json:"id_declaration_form_6_companies,omitempty" toml:"id_declaration_form_6_companies" yaml:"id_declaration_form_6_companies,omitempty"`
...
var DeclarationForm6ContentWhere = struct {
	ID                          whereHelperint64
	IDDeclarationForm6Companies whereHelpernull_Int64
	...
	ID:                          whereHelperint64{field: "\"declaration_form_6_content\".\"id\""},
	IDDeclarationForm6Companies: whereHelpernull_Int64{field: "\"declaration_form_6_content\".\"id_declaration_form_6_companies\""},
	ActivityCode:                whereHelpernull_String{field: "\"declaration_form_6_content\".\"activity_code\""},
	ActivityName:                whereHelpernull_String{field: "\"declaration_form_6_content\".\"activity_name\""},
	ProductCode:                 whereHelpernull_String{field: "\"declaration_form_6_content\".\"product_code\""},
	ProductCodeName:             whereHelpernull_String{field: "\"declaration_form_6_content\".\"product_code_name\""},
	PowerYear:                   whereHelpernull_String{field: "\"declaration_form_6_content\".\"power_year\""},
	PowerFirstQuarter:           whereHelpernull_String{field: "\"declaration_form_6_content\".\"power_first_quarter\""},
	PowerSecondQuarter:          whereHelpernull_String{field: "\"declaration_form_6_content\".\"power_second_quarter\""},
	PowerThirdQuarter:           whereHelpernull_String{field: "\"declaration_form_6_content\".\"power_third_quarter\""},
	PowerFourthQuarter:          whereHelpernull_String{field: "\"declaration_form_6_content\".\"power_fourth_quarter\""},
	Production:                  whereHelpernull_String{field: "\"declaration_form_6_content\".\"production\""},
	Utilization:                 whereHelpernull_String{field: "\"declaration_form_6_content\".\"utilization\""},
}
...
var (
	...
	declarationForm6ContentColumnsWithoutDefault = []string{}
	declarationForm6ContentColumnsWithDefault    = []string{"id", "id_declaration_form_6_companies", "activity_code", "activity_name", "product_code", "product_code_name", "power_year", "power_first_quarter", "power_second_quarter", "power_third_quarter", "power_fourth_quarter", "production", "utilization"}
...
func DeclarationForm6Contents(mods ...qm.QueryMod) declarationForm6ContentQuery {
	mods = append(mods, qm.From("\"declaration_form_6_content\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"declaration_form_6_content\".*"})
	}
...
func FindDeclarationForm6ContentG(ctx context.Context, iD int64, selectCols ...string) (*DeclarationForm6Content, error) {
...
func FindDeclarationForm6Content(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*DeclarationForm6Content, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"declaration_form_6_content\" where \"id\"=?", sel,
	)
...
func (o *DeclarationForm6Content) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"declaration_form_6_content\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"declaration_form_6_content\" %sDEFAULT VALUES%s"
		}
...
func (o *DeclarationForm6Content) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"declaration_form_6_content\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, declarationForm6ContentPrimaryKeyColumns),
		)
...
func (o DeclarationForm6ContentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"declaration_form_6_content\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, declarationForm6ContentPrimaryKeyColumns, len(o)))
...
func (o *DeclarationForm6Content) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *DeclarationForm6Content) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(declarationForm6ContentPrimaryKeyColumns))
			copy(conflict, declarationForm6ContentPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"declaration_form_6_content\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(declarationForm6ContentType, declarationForm6ContentMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *DeclarationForm6Content) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"declaration_form_6_content\" WHERE \"id\"=?"
...
func (o DeclarationForm6ContentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"declaration_form_6_content\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, declarationForm6ContentPrimaryKeyColumns, len(o))
...
func (o *DeclarationForm6ContentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"declaration_form_6_content\".* FROM \"declaration_form_6_content\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, declarationForm6ContentPrimaryKeyColumns, len(*o))
...
func DeclarationForm6ContentExistsG(ctx context.Context, iD int64) (bool, error) {
...
func DeclarationForm6ContentExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"declaration_form_6_content\" where \"id\"=? limit 1)"
