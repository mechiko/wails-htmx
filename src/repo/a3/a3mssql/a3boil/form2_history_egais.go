...
var Form2HistoryEgaisTableColumns = struct {
	...
	IDRequests:       "form2_history_egais.id_requests",
...
var Form2HistoryEgaisWhere = struct {
	...
	ID:               whereHelperint{field: "[dbo].[form2_history_egais].[id]"},
	IDRequests:       whereHelpernull_Int{field: "[dbo].[form2_history_egais].[id_requests]"},
	DocType:          whereHelpernull_String{field: "[dbo].[form2_history_egais].[doc_type]"},
	DocID:            whereHelpernull_String{field: "[dbo].[form2_history_egais].[doc_id]"},
	ProductQuantity:  whereHelpernull_String{field: "[dbo].[form2_history_egais].[product_quantity]"},
	OperationName:    whereHelpernull_String{field: "[dbo].[form2_history_egais].[operation_name]"},
	OperationDate:    whereHelpernull_String{field: "[dbo].[form2_history_egais].[operation_date]"},
	Form2HistoryDate: whereHelpernull_String{field: "[dbo].[form2_history_egais].[form2_history_date]"},
}
...
var (
	form2HistoryEgaisAllColumns            = []string{"id", "id_requests", "doc_type", "doc_id", "product_quantity", "operation_name", "operation_date", "form2_history_date"}
	form2HistoryEgaisColumnsWithoutDefault = []string{"id_requests", "doc_type", "doc_id", "product_quantity", "operation_name", "operation_date", "form2_history_date"}
	form2HistoryEgaisColumnsWithDefault    = []string{"id"}
...
func (q form2HistoryEgaisQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Form2HistoryEgais, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "a3boil: failed to execute a one query for form2_history_egais")
	}
...
func (q form2HistoryEgaisQuery) All(ctx context.Context, exec boil.ContextExecutor) (Form2HistoryEgaisSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "a3boil: failed to assign all query results to Form2HistoryEgais slice")
	}
...
func (q form2HistoryEgaisQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: failed to count form2_history_egais rows")
	}
...
func (q form2HistoryEgaisQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "a3boil: failed to check if form2_history_egais exists")
	}
...
func Form2HistoryEgaiss(mods ...qm.QueryMod) form2HistoryEgaisQuery {
	mods = append(mods, qm.From("[dbo].[form2_history_egais]"))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"[dbo].[form2_history_egais].*"})
	}
...
func FindForm2HistoryEgaisG(ctx context.Context, iD int, selectCols ...string) (*Form2HistoryEgais, error) {
...
func FindForm2HistoryEgais(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Form2HistoryEgais, error) {
	...
	query := fmt.Sprintf(
		"select %s from [dbo].[form2_history_egais] where [id]=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "a3boil: unable to select from form2_history_egais")
	}
...
func (o *Form2HistoryEgais) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("a3boil: no form2_history_egais provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO [dbo].[form2_history_egais] ([%s]) %%sVALUES (%s)%%s", strings.Join(wl, "],["), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO [dbo].[form2_history_egais] %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "a3boil: unable to insert into form2_history_egais")
	}
...
func (o *Form2HistoryEgais) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("a3boil: unable to update form2_history_egais, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE [dbo].[form2_history_egais] SET %s WHERE %s",
			strmangle.SetParamNames("[", "]", 1, wl),
			strmangle.WhereClause("[", "]", len(wl)+1, form2HistoryEgaisPrimaryKeyColumns),
		)
	...
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to update form2_history_egais row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: failed to get rows affected by update for form2_history_egais")
	}
...
func (q form2HistoryEgaisQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to update all for form2_history_egais")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to retrieve rows affected for form2_history_egais")
	}
...
func (o Form2HistoryEgaisSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE [dbo].[form2_history_egais] SET %s WHERE %s",
		strmangle.SetParamNames("[", "]", 1, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), len(colNames)+1, form2HistoryEgaisPrimaryKeyColumns, len(o)))
	...
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to update all in form2HistoryEgais slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to retrieve rows affected all in update all form2HistoryEgais")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *Form2HistoryEgais) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
func (o *Form2HistoryEgais) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("a3boil: no form2_history_egais provided for upsert")
	}
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, form2HistoryEgaisGeneratedColumns)

		for i, v := range insert {
			if strmangle.ContainsAny(form2HistoryEgaisPrimaryKeyColumns, v) && strmangle.ContainsAny(form2HistoryEgaisColumnsWithDefault, v) {
				insert = append(insert[:i], insert[i+1:]...)
			}
		}
		if len(insert) == 0 {
			return errors.New("a3boil: unable to upsert form2_history_egais, could not build insert column list")
		}
		...
		ret := strmangle.SetComplement(form2HistoryEgaisAllColumns, strmangle.SetIntersect(insert, update))

		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("a3boil: unable to upsert form2_history_egais, could not build update column list")
		}

		cache.query = buildUpsertQueryMSSQL(dialect, "[dbo].[form2_history_egais]", form2HistoryEgaisPrimaryKeyColumns, update, insert, ret)

		whitelist := make([]string, len(form2HistoryEgaisPrimaryKeyColumns))
		copy(whitelist, form2HistoryEgaisPrimaryKeyColumns)
		whitelist = append(whitelist, update...)
		whitelist = append(whitelist, insert...)

		cache.valueMapping, err = queries.BindMapping(form2HistoryEgaisType, form2HistoryEgaisMapping, whitelist)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
	...
	if err != nil {
		return errors.Wrap(err, "a3boil: unable to upsert form2_history_egais")
	}
...
func (o *Form2HistoryEgais) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("a3boil: no Form2HistoryEgais provided for delete")
	}
	...
	sql := "DELETE FROM [dbo].[form2_history_egais] WHERE [id]=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to delete from form2_history_egais")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: failed to get rows affected by delete for form2_history_egais")
	}
...
func (q form2HistoryEgaisQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("a3boil: no form2HistoryEgaisQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to delete all from form2_history_egais")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: failed to get rows affected by deleteall for form2_history_egais")
	}
...
func (o Form2HistoryEgaisSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM [dbo].[form2_history_egais] WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, form2HistoryEgaisPrimaryKeyColumns, len(o))
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "a3boil: unable to delete all from form2HistoryEgais slice")
	}
...
func (o *Form2HistoryEgais) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("a3boil: no Form2HistoryEgais provided for reload")
	}
...
func (o *Form2HistoryEgaisSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("a3boil: empty Form2HistoryEgaisSlice provided for reload all")
	}
...
func (o *Form2HistoryEgaisSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT [dbo].[form2_history_egais].* FROM [dbo].[form2_history_egais] WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, form2HistoryEgaisPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "a3boil: unable to reload all in Form2HistoryEgaisSlice")
	}
...
func Form2HistoryEgaisExistsG(ctx context.Context, iD int) (bool, error) {
...
func Form2HistoryEgaisExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select case when exists(select top(1) 1 from [dbo].[form2_history_egais] where [id]=$1) then 1 else 0 end"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "a3boil: unable to check if form2_history_egais exists")
	}
