...
var TicketWhere = struct {
	...
	DocDate: whereHelpernull_String{field: "[dbo].[tickets].[doc_date]"},
	Errors:  whereHelpernull_String{field: "[dbo].[tickets].[errors]"},
}
...
var (
	...
	ticketColumnsWithoutDefault = []string{"doc_id", "doc_type", "doc_date", "errors"}
...
func (o *Ticket) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if len(insert) == 0 {
			return errors.New("znakboil: unable to upsert tickets, could not build insert column list")
		}
