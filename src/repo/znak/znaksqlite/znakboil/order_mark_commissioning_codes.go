...
var OrderMarkCommissioningCodeWhere = struct {
	...
	ID:                       whereHelperint64{field: "\"order_mark_commissioning_codes\".\"id\""},
	IDOrderMarkCommissioning: whereHelpernull_Int64{field: "\"order_mark_commissioning_codes\".\"id_order_mark_commissioning\""},
	IDOrderMarkUtilisation:   whereHelpernull_Int64{field: "\"order_mark_commissioning_codes\".\"id_order_mark_utilisation\""},
	IDOrderMarkCodes:         whereHelpernull_Int64{field: "\"order_mark_commissioning_codes\".\"id_order_mark_codes\""},
	SerialNumber:             whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"serial_number\""},
	Code:                     whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"code\""},
	Tnved:                    whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"tnved\""},
	Price:                    whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"price\""},
	NDS:                      whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"nds\""},
	Excise:                   whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"excise\""},
	Status:                   whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"status\""},
	ProductName:              whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_name\""},
	ProductGtin:              whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_gtin\""},
	ProductDeclarationNumber: whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_declaration_number\""},
	ProductDeclarationDate:   whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_declaration_date\""},
	ReportDate:               whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"report_date\""},
	ReportID:                 whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"report_id\""},
	ProductCertificateNumber: whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_certificate_number\""},
	ProductCertificateDate:   whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_certificate_date\""},
	ProductStateNumber:       whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_state_number\""},
	ProductStateDate:         whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"product_state_date\""},
	WaterLicenseNumber:       whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"water_license_number\""},
	WaterLicenseDate:         whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"water_license_date\""},
	WaterWellNumber:          whereHelpernull_String{field: "\"order_mark_commissioning_codes\".\"water_well_number\""},
}
...
var (
	orderMarkCommissioningCodeAllColumns            = []string{"id", "id_order_mark_commissioning", "id_order_mark_utilisation", "id_order_mark_codes", "serial_number", "code", "tnved", "price", "nds", "excise", "status", "product_name", "product_gtin", "product_declaration_number", "product_declaration_date", "report_date", "report_id", "product_certificate_number", "product_certificate_date", "product_state_number", "product_state_date", "water_license_number", "water_license_date", "water_well_number"}
	orderMarkCommissioningCodeColumnsWithoutDefault = []string{}
	orderMarkCommissioningCodeColumnsWithDefault    = []string{"id", "id_order_mark_commissioning", "id_order_mark_utilisation", "id_order_mark_codes", "serial_number", "code", "tnved", "price", "nds", "excise", "status", "product_name", "product_gtin", "product_declaration_number", "product_declaration_date", "report_date", "report_id", "product_certificate_number", "product_certificate_date", "product_state_number", "product_state_date", "water_license_number", "water_license_date", "water_well_number"}
...
func OrderMarkCommissioningCodes(mods ...qm.QueryMod) orderMarkCommissioningCodeQuery {
	mods = append(mods, qm.From("\"order_mark_commissioning_codes\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"order_mark_commissioning_codes\".*"})
	}
...
func FindOrderMarkCommissioningCodeG(ctx context.Context, iD int64, selectCols ...string) (*OrderMarkCommissioningCode, error) {
...
func FindOrderMarkCommissioningCode(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*OrderMarkCommissioningCode, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"order_mark_commissioning_codes\" where \"id\"=?", sel,
	)
...
func (o *OrderMarkCommissioningCode) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"order_mark_commissioning_codes\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"order_mark_commissioning_codes\" %sDEFAULT VALUES%s"
		}
...
func (o *OrderMarkCommissioningCode) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"order_mark_commissioning_codes\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, orderMarkCommissioningCodePrimaryKeyColumns),
		)
...
func (o OrderMarkCommissioningCodeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"order_mark_commissioning_codes\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkCommissioningCodePrimaryKeyColumns, len(o)))
...
func (o *OrderMarkCommissioningCode) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *OrderMarkCommissioningCode) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(orderMarkCommissioningCodePrimaryKeyColumns))
			copy(conflict, orderMarkCommissioningCodePrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"order_mark_commissioning_codes\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(orderMarkCommissioningCodeType, orderMarkCommissioningCodeMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *OrderMarkCommissioningCode) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_mark_commissioning_codes\" WHERE \"id\"=?"
...
func (o OrderMarkCommissioningCodeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_mark_commissioning_codes\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkCommissioningCodePrimaryKeyColumns, len(o))
...
func (o *OrderMarkCommissioningCodeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"order_mark_commissioning_codes\".* FROM \"order_mark_commissioning_codes\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkCommissioningCodePrimaryKeyColumns, len(*o))
...
func OrderMarkCommissioningCodeExistsG(ctx context.Context, iD int64) (bool, error) {
...
func OrderMarkCommissioningCodeExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"order_mark_commissioning_codes\" where \"id\"=? limit 1)"
