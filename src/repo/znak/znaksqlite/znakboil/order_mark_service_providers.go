...
var OrderMarkServiceProviderWhere = struct {
	...
	ID:                  whereHelperint64{field: "\"order_mark_service_providers\".\"id\""},
	OrderMarkTemplateID: whereHelpernull_String{field: "\"order_mark_service_providers\".\"order_mark_template_id\""},
	ProviderID:          whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_id\""},
	ProviderName:        whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_name\""},
	ProviderPlatform:    whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_platform\""},
	ProviderTaxID:       whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_tax_id\""},
	ProviderCountry:     whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_country\""},
	ProviderEmail:       whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_email\""},
	ProviderRole:        whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_role\""},
	ProviderGroup:       whereHelpernull_String{field: "\"order_mark_service_providers\".\"provider_group\""},
}
...
var (
	...
	orderMarkServiceProviderColumnsWithoutDefault = []string{}
	orderMarkServiceProviderColumnsWithDefault    = []string{"id", "order_mark_template_id", "provider_id", "provider_name", "provider_platform", "provider_tax_id", "provider_country", "provider_email", "provider_role", "provider_group"}
...
func OrderMarkServiceProviders(mods ...qm.QueryMod) orderMarkServiceProviderQuery {
	mods = append(mods, qm.From("\"order_mark_service_providers\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"order_mark_service_providers\".*"})
	}
...
func FindOrderMarkServiceProviderG(ctx context.Context, iD int64, selectCols ...string) (*OrderMarkServiceProvider, error) {
...
func FindOrderMarkServiceProvider(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*OrderMarkServiceProvider, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"order_mark_service_providers\" where \"id\"=?", sel,
	)
...
func (o *OrderMarkServiceProvider) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"order_mark_service_providers\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"order_mark_service_providers\" %sDEFAULT VALUES%s"
		}
...
func (o *OrderMarkServiceProvider) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"order_mark_service_providers\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, orderMarkServiceProviderPrimaryKeyColumns),
		)
...
func (o OrderMarkServiceProviderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"order_mark_service_providers\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkServiceProviderPrimaryKeyColumns, len(o)))
...
func (o *OrderMarkServiceProvider) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *OrderMarkServiceProvider) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(orderMarkServiceProviderPrimaryKeyColumns))
			copy(conflict, orderMarkServiceProviderPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"order_mark_service_providers\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(orderMarkServiceProviderType, orderMarkServiceProviderMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *OrderMarkServiceProvider) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_mark_service_providers\" WHERE \"id\"=?"
...
func (o OrderMarkServiceProviderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_mark_service_providers\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkServiceProviderPrimaryKeyColumns, len(o))
...
func (o *OrderMarkServiceProviderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"order_mark_service_providers\".* FROM \"order_mark_service_providers\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkServiceProviderPrimaryKeyColumns, len(*o))
...
func OrderMarkServiceProviderExistsG(ctx context.Context, iD int64) (bool, error) {
...
func OrderMarkServiceProviderExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"order_mark_service_providers\" where \"id\"=? limit 1)"
