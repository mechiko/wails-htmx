...
var OrderMarkAtkWhere = struct {
	...
	ID:         whereHelperint64{field: "\"order_mark_atk\".\"id\""},
	CreateDate: whereHelpernull_String{field: "\"order_mark_atk\".\"create_date\""},
	Inn:        whereHelpernull_String{field: "\"order_mark_atk\".\"inn\""},
	Version:    whereHelpernull_String{field: "\"order_mark_atk\".\"version\""},
	State:      whereHelpernull_String{field: "\"order_mark_atk\".\"state\""},
	Status:     whereHelpernull_String{field: "\"order_mark_atk\".\"status\""},
	AtkCode:    whereHelpernull_String{field: "\"order_mark_atk\".\"atk_code\""},
	OrderID:    whereHelpernull_String{field: "\"order_mark_atk\".\"order_id\""},
	Archive:    whereHelpernull_Int64{field: "\"order_mark_atk\".\"archive\""},
	JSON:       whereHelpernull_String{field: "\"order_mark_atk\".\"json\""},
	Quantity:   whereHelpernull_String{field: "\"order_mark_atk\".\"quantity\""},
}
...
var (
	orderMarkAtkAllColumns            = []string{"id", "create_date", "inn", "version", "state", "status", "atk_code", "order_id", "archive", "json", "quantity"}
	orderMarkAtkColumnsWithoutDefault = []string{}
	orderMarkAtkColumnsWithDefault    = []string{"id", "create_date", "inn", "version", "state", "status", "atk_code", "order_id", "archive", "json", "quantity"}
...
func OrderMarkAtks(mods ...qm.QueryMod) orderMarkAtkQuery {
	mods = append(mods, qm.From("\"order_mark_atk\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"order_mark_atk\".*"})
	}
...
func FindOrderMarkAtkG(ctx context.Context, iD int64, selectCols ...string) (*OrderMarkAtk, error) {
...
func FindOrderMarkAtk(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*OrderMarkAtk, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"order_mark_atk\" where \"id\"=?", sel,
	)
...
func (o *OrderMarkAtk) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"order_mark_atk\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"order_mark_atk\" %sDEFAULT VALUES%s"
		}
...
func (o *OrderMarkAtk) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"order_mark_atk\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, orderMarkAtkPrimaryKeyColumns),
		)
...
func (o OrderMarkAtkSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"order_mark_atk\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkAtkPrimaryKeyColumns, len(o)))
...
func (o *OrderMarkAtk) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *OrderMarkAtk) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(orderMarkAtkPrimaryKeyColumns))
			copy(conflict, orderMarkAtkPrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"order_mark_atk\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(orderMarkAtkType, orderMarkAtkMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *OrderMarkAtk) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_mark_atk\" WHERE \"id\"=?"
...
func (o OrderMarkAtkSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_mark_atk\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkAtkPrimaryKeyColumns, len(o))
...
func (o *OrderMarkAtkSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"order_mark_atk\".* FROM \"order_mark_atk\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderMarkAtkPrimaryKeyColumns, len(*o))
...
func OrderMarkAtkExistsG(ctx context.Context, iD int64) (bool, error) {
	return OrderMarkAtkExists(ctx, boil.GetContextDB(), iD)
}

// OrderMarkAtkExists checks if the OrderMarkAtk row exists.
func OrderMarkAtkExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"order_mark_atk\" where \"id\"=? limit 1)"
