...
type Ticket struct {
	...
	Errors  null.String `boil:"errors" json:"errors,omitempty" toml:"errors" yaml:"errors,omitempty"`
...
var TicketWhere = struct {
	...
	Errors  whereHelpernull_String
}{
	ID:      whereHelperint64{field: "\"tickets\".\"id\""},
	DocID:   whereHelpernull_String{field: "\"tickets\".\"doc_id\""},
	DocType: whereHelpernull_String{field: "\"tickets\".\"doc_type\""},
	DocDate: whereHelpernull_String{field: "\"tickets\".\"doc_date\""},
	Errors:  whereHelpernull_String{field: "\"tickets\".\"errors\""},
}
...
var (
	ticketAllColumns            = []string{"id", "doc_id", "doc_type", "doc_date", "errors"}
	ticketColumnsWithoutDefault = []string{}
	ticketColumnsWithDefault    = []string{"id", "doc_id", "doc_type", "doc_date", "errors"}
...
func (q ticketQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Ticket, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "znakboil: failed to execute a one query for tickets")
	}
...
func (q ticketQuery) All(ctx context.Context, exec boil.ContextExecutor) (TicketSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "znakboil: failed to assign all query results to Ticket slice")
	}
...
func (q ticketQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: failed to count tickets rows")
	}
...
func (q ticketQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "znakboil: failed to check if tickets exists")
	}
...
func FindTicket(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Ticket, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"tickets\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "znakboil: unable to select from tickets")
	}
...
func (o *Ticket) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("znakboil: no tickets provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "znakboil: unable to insert into tickets")
	}
...
func (o *Ticket) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("znakboil: unable to update tickets, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to update tickets row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: failed to get rows affected by update for tickets")
	}
...
func (q ticketQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to update all for tickets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to retrieve rows affected for tickets")
	}
...
func (o TicketSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to update all in ticket slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to retrieve rows affected all in update all ticket")
	}
	return rowsAff, nil
}
...
func (o *Ticket) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("znakboil: no tickets provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("znakboil: unable to upsert tickets, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"tickets\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "znakboil: unable to upsert tickets")
	}
...
func (o *Ticket) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("znakboil: no Ticket provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to delete from tickets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: failed to get rows affected by delete for tickets")
	}
...
func (q ticketQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("znakboil: no ticketQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to delete all from tickets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: failed to get rows affected by deleteall for tickets")
	}
...
func (o TicketSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "znakboil: unable to delete all from ticket slice")
	}
...
func (o *Ticket) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("znakboil: no Ticket provided for reload")
	}
...
func (o *TicketSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("znakboil: empty TicketSlice provided for reload all")
	}
...
func (o *TicketSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "znakboil: unable to reload all in TicketSlice")
	}
...
func TicketExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"tickets\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "znakboil: unable to check if tickets exists")
	}
