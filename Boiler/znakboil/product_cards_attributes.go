...
type ProductCardsAttribute struct {
	...
	AttrID                        null.Int64  `boil:"attr_id" json:"attr_id,omitempty" toml:"attr_id" yaml:"attr_id,omitempty"`
	...
	ValueID                       null.Int64  `boil:"value_id" json:"value_id,omitempty" toml:"value_id" yaml:"value_id,omitempty"`
	...
	AttrGroupID                   null.Int64  `boil:"attr_group_id" json:"attr_group_id,omitempty" toml:"attr_group_id" yaml:"attr_group_id,omitempty"`
	...
	Multiplier                    null.Int64  `boil:"multiplier" json:"multiplier,omitempty" toml:"multiplier" yaml:"multiplier,omitempty"`
...
var ProductCardsAttributeWhere = struct {
	...
	Multiplier                    whereHelpernull_Int64
	...
	ID:                            whereHelperint64{field: "\"product_cards_attributes\".\"id\""},
	IDProductCards:                whereHelpernull_Int64{field: "\"product_cards_attributes\".\"id_product_cards\""},
	AttrID:                        whereHelpernull_Int64{field: "\"product_cards_attributes\".\"attr_id\""},
	AttrName:                      whereHelpernull_String{field: "\"product_cards_attributes\".\"attr_name\""},
	AttrValueID:                   whereHelpernull_String{field: "\"product_cards_attributes\".\"attr_value_id\""},
	AttrValue:                     whereHelpernull_String{field: "\"product_cards_attributes\".\"attr_value\""},
	ValueID:                       whereHelpernull_Int64{field: "\"product_cards_attributes\".\"value_id\""},
	AttrValueType:                 whereHelpernull_String{field: "\"product_cards_attributes\".\"attr_value_type\""},
	AttrGroupID:                   whereHelpernull_Int64{field: "\"product_cards_attributes\".\"attr_group_id\""},
	AttrGroupName:                 whereHelpernull_String{field: "\"product_cards_attributes\".\"attr_group_name\""},
	MeasureDate:                   whereHelpernull_String{field: "\"product_cards_attributes\".\"measure_date\""},
	PublishedDate:                 whereHelpernull_String{field: "\"product_cards_attributes\".\"published_date\""},
	EffectiveDate:                 whereHelpernull_String{field: "\"product_cards_attributes\".\"effective_date\""},
	ExpiredDate:                   whereHelpernull_String{field: "\"product_cards_attributes\".\"expired_date\""},
	LocationID:                    whereHelpernull_String{field: "\"product_cards_attributes\".\"location_id\""},
	PartyLocationID:               whereHelpernull_String{field: "\"product_cards_attributes\".\"party_location_id\""},
	Level:                         whereHelpernull_String{field: "\"product_cards_attributes\".\"level\""},
	Gtin:                          whereHelpernull_String{field: "\"product_cards_attributes\".\"gtin\""},
	Multiplier:                    whereHelpernull_Int64{field: "\"product_cards_attributes\".\"multiplier\""},
	CertificateNumber:             whereHelpernull_String{field: "\"product_cards_attributes\".\"certificate_number\""},
	CertificateIssuedDate:         whereHelpernull_String{field: "\"product_cards_attributes\".\"certificate_issued_date\""},
	CertificateValidUntilDate:     whereHelpernull_String{field: "\"product_cards_attributes\".\"certificate_valid_until_date\""},
	CertificateApplicant:          whereHelpernull_String{field: "\"product_cards_attributes\".\"certificate_applicant\""},
	CertificateManufacturer:       whereHelpernull_String{field: "\"product_cards_attributes\".\"certificate_manufacturer\""},
	CertificateProductDescription: whereHelpernull_String{field: "\"product_cards_attributes\".\"certificate_product_description\""},
}
...
var (
	...
	productCardsAttributeColumnsWithoutDefault = []string{}
	productCardsAttributeColumnsWithDefault    = []string{"id", "id_product_cards", "attr_id", "attr_name", "attr_value_id", "attr_value", "value_id", "attr_value_type", "attr_group_id", "attr_group_name", "measure_date", "published_date", "effective_date", "expired_date", "location_id", "party_location_id", "level", "gtin", "multiplier", "certificate_number", "certificate_issued_date", "certificate_valid_until_date", "certificate_applicant", "certificate_manufacturer", "certificate_product_description"}
...
func ProductCardsAttributes(mods ...qm.QueryMod) productCardsAttributeQuery {
	mods = append(mods, qm.From("\"product_cards_attributes\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"product_cards_attributes\".*"})
	}
...
func FindProductCardsAttributeG(ctx context.Context, iD int64, selectCols ...string) (*ProductCardsAttribute, error) {
...
func FindProductCardsAttribute(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ProductCardsAttribute, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"product_cards_attributes\" where \"id\"=?", sel,
	)
...
func (o *ProductCardsAttribute) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"product_cards_attributes\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"product_cards_attributes\" %sDEFAULT VALUES%s"
		}
...
func (o *ProductCardsAttribute) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"product_cards_attributes\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, productCardsAttributePrimaryKeyColumns),
		)
...
func (o ProductCardsAttributeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"product_cards_attributes\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 0, colNames),
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productCardsAttributePrimaryKeyColumns, len(o)))
...
func (o *ProductCardsAttribute) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *ProductCardsAttribute) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(productCardsAttributePrimaryKeyColumns))
			copy(conflict, productCardsAttributePrimaryKeyColumns)
		}
		cache.query = buildUpsertQuerySQLite(dialect, "\"product_cards_attributes\"", updateOnConflict, ret, update, conflict, insert)

		cache.valueMapping, err = queries.BindMapping(productCardsAttributeType, productCardsAttributeMapping, insert)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
func (o *ProductCardsAttribute) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"product_cards_attributes\" WHERE \"id\"=?"
...
func (o ProductCardsAttributeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"product_cards_attributes\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productCardsAttributePrimaryKeyColumns, len(o))
...
func (o *ProductCardsAttributeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"product_cards_attributes\".* FROM \"product_cards_attributes\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, productCardsAttributePrimaryKeyColumns, len(*o))
...
func ProductCardsAttributeExistsG(ctx context.Context, iD int64) (bool, error) {
...
func ProductCardsAttributeExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"product_cards_attributes\" where \"id\"=? limit 1)"
