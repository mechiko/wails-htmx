...
type OrderMarkUtilisation struct {
	...
	PrimaryDocNumber null.String `boil:"primary_doc_number" json:"primary_doc_number,omitempty" toml:"primary_doc_number" yaml:"primary_doc_number,omitempty"`
	PrimaryDocDate   null.String `boil:"primary_doc_date" json:"primary_doc_date,omitempty" toml:"primary_doc_date" yaml:"primary_doc_date,omitempty"`
	AlcVolume        null.String `boil:"alc_volume" json:"alc_volume,omitempty" toml:"alc_volume" yaml:"alc_volume,omitempty"`
...
var OrderMarkUtilisationColumns = struct {
	...
	JSON:             "json",
	Quantity:         "quantity",
	PrimaryDocNumber: "primary_doc_number",
	PrimaryDocDate:   "primary_doc_date",
...
var OrderMarkUtilisationTableColumns = struct {
	...
	PrimaryDocNumber: "order_mark_utilisation.primary_doc_number",
	PrimaryDocDate:   "order_mark_utilisation.primary_doc_date",
	AlcVolume:        "order_mark_utilisation.alc_volume",
}
...
var OrderMarkUtilisationWhere = struct {
	...
	PrimaryDocNumber whereHelpernull_String
	PrimaryDocDate   whereHelpernull_String
	AlcVolume        whereHelpernull_String
}{
	...
	PrimaryDocNumber: whereHelpernull_String{field: "\"order_mark_utilisation\".\"primary_doc_number\""},
	PrimaryDocDate:   whereHelpernull_String{field: "\"order_mark_utilisation\".\"primary_doc_date\""},
	AlcVolume:        whereHelpernull_String{field: "\"order_mark_utilisation\".\"alc_volume\""},
}
...
var (
	orderMarkUtilisationAllColumns            = []string{"id", "id_order_mark_codes", "create_date", "production_date", "expiration_date", "usage_type", "inn", "kpp", "version", "state", "status", "report_id", "archive", "json", "quantity", "primary_doc_number", "primary_doc_date", "alc_volume"}
	orderMarkUtilisationColumnsWithoutDefault = []string{}
	orderMarkUtilisationColumnsWithDefault    = []string{"id", "id_order_mark_codes", "create_date", "production_date", "expiration_date", "usage_type", "inn", "kpp", "version", "state", "status", "report_id", "archive", "json", "quantity", "primary_doc_number", "primary_doc_date", "alc_volume"}
